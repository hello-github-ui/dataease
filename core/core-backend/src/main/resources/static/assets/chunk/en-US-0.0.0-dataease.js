const e = {
    ...
    toolbox: {name: "Toolbox", template_center: "Template center", org_center: "Organization management center"},
    operate_log: {
        name: "Operation log",
    ...
    data_set: {
        ...
        be_reported_incorrectly: "You are doing cross-data source table association, please make sure to use calcite's standard syntax and functions,otherwise it will cause dataset errors",
    ...
    data_source: {
        ...
        operate_with_caution: "After deletion, all resources under this folder will be deleted. Please operate with caution.",
        confirm_to_delete: "A dataset is using this Datasource. After deletion, the dataset will be unavailable. Confirm the deletion? ",
    ...
    dynamic_year: {fix: "Fixed year", dynamic: "Dynamic year", current: "This year", last: "Last year"},
    dynamic_month: {
    ...
    org: {
        ...
        confirm_content: "A friendly reminder: After an organization is deleted, the resources under it will be treated as free-floating resources.",
    ...
    datasource: {
        ...
        edit_datasource_msg: "Modifying the Datasource information may make the Dataset under the Datasource unavailable. Confirm the modification? ",
  ...
  Scatter chart (bubble) chart: {a} (series name), {b} (data name), {c} (value array), {d} (none)`,
        ...
        merge_cells_tips: "After merging cells, freezing rows and columns and automatic line wrapping will become invalid",
        ...
        custom_label_content_tip: "Can read field values in the form of ${'{'}fieldName{'}'} (does not support line breaks) ",
        ...
        custom_tooltip_content_tip: "Can read field values in the form of ${'{'}fieldName{'}'} (Support HTML) ",
        ...
        flow_map_line_width_tip: "When this metric is active, the line width property configured in the style will be overridden",
        symbolic_map_coordinates: "Coordinates",
        symbolic_map_bubble_size_tip: "When this metric is active, the size property configured in the base style will be overridden. Additionally, you can configure a size range in the base style",
        ...
        symbolic_map_symbol_shape_tip: "When Customizing, Supports SVG, JPG, JPEG, and PNG files up to 1MB",
    ...
    dataset: {
        ...
        full_join: "Full join",
        can_not_union_diff_datasource: "The associated dataset must be consistent with the Datasource of the current dataset",
        operator: "Operation",
        ...
        merge_msg: "There are fields that are consistent in the data table. Do you want to merge them into one Dataset?",
        ...
        sync_success_1: "Synchronize successfully, please re-execute data synchronization operation on current Dataset",
        row_permission: {
            type: "Type",
            name: "Name",
            condition: "Condition",
        ...
        calc_tips: {
            ...
            tip1_1: "The expression syntax should follow the database syntax corresponding to the Datasource. ",
    ...
    commons: {
        ...
        table: {select_tip: "{0} data items have been selected"},
        date: {
            select_date: "Select date",
        ...
        adv_search: {
            ...
            message_box: {alert: "Warning", confirm: "Confirm"}
        },
        monitor: "Monitor",
        image: "Image",
        tag: "Tag",
        module: {select_module: "Select module", default_module: "Default module"},
        datasource: "Datasource",
        ...
        message_box: {alert: "Warning", confirm: "Confirm", ok: "Confirm", cancel: "Cancel"},
        ukey_title: "API Keys",
        thumbnail: "Thumbnail",
        confirm_delete: "Confirm deletion",
    ...
    sql_variable: {variable_mgm: "Parameter settings"},
    v_query: {
        ...
        configure_cascaded_fields: "Use the same Dataset as the previous level, no need to configure the cascaded fields",
        ...
        must_be_met: "Based on the condition of the current component, if cascade configuration is required, the following conditions must be met:",
        select_data_set: "1. Display type: text drop-down component and number drop-down component; 2. Option value source: select Dataset",
        ...
        be_switched_to: "Note: Automatic mode supports automatic association of fields with the same Dataset, which can be switched to",
        ...
        cannot_be_displayed: "The chart uses a different Dataset, Unable to display configuration items",
    ...
    visualization: {
        ...
        cell_merge_tips: "After merging cells, row/column freezing and automatic line wrapping will be disabled.",
        image: "Image",
        ...
        query_tips: "If the query button is displayed, the chart query will be triggered only after clicking the button. If not displayed, the query is triggered immediately after selecting the query conditions.",
        ...
        delete_tips: "After deletion, all resources under this folder will be deleted, please operate with caution.",
        delete_warn: "Are you sure you want to delete this {0}?",
        save_app: "Save Application",
        base_info: "Basic Information",
        close: "Close",
        adapt_new_subject: "Adapt to New Theme",
        export_tips: "The {0} in the current dashboard belongs to a template chart and cannot be exported. Please set the dataset first!",
        ...
        event_binding_tips: "Event binding will take effect after exiting edit mode. If rich text has event binding enabled, internal click events will be disabled",
        ...
        pop_area_tips: "Click or drag the query component to this position, click preview to view the pop-up area",
        view: "View",
        ...
        params_setting_check_message_tips: "There are unconfigured parameter names or duplicate parameter names!",
        ...
        linkage_option_tips1: "If the linkage dimension has been configured for drilling, clicking the dimension will",
        ...
        link_target_tips1: "The target dashboard has no external parameters, so conditional queries cannot be carried out. If needed,",
        ...
        unpublished_tips: "After canceling publication, this dashboard cannot be viewed. Are you sure you want to cancel publication?",
        ...
        watermark: "Watermark",
        panel_get_data_error: "Failed to retrieve dashboard information. The dashboard may have been deleted. Please check the dashboard status.",
        panel_no_save_tips: "There are unsaved dashboards.",
        panel_cache_use_tips: "We detected that a dashboard failed to save properly last time. Would you like to use the unsaved version?",
        ...
        market_network_tips: "To view templates from the template market, your server must be connected to the template market (https://templates.dataease.cn). Please check your network connection...",
        ...
        theme_change_tips: "Changing the theme will overwrite related chart theme properties. It is recommended to back up your settings before proceeding. Do you want to continue?",
        ...
        outer_param_decode_error: "External parameter parsing error. Please encode parameters as specified.",
        ...
        panel_view_result_tips: "Selecting {0} will overwrite the number of chart results shown, with a value range of 1-10000",
        timeout_refresh: "Request timed out, please refresh later...",
        mobile_layout: "Mobile Layout",
        component_hidden: "Hidden Components",
        public_link_tips: "Currently in public link mode, the target dashboard has not set up public links, unable to jump",
    ...
    work_branch: {
        ...
        template_market_official: "For template download link, please contact the official template market",
        ...
        cannot_share_link: "Global sharing has been disabled. Sharing is temporarily unavailable. Please contact the administrator!",
        ...
        password_hint: "Password must be a 4-10 character string containing numbers, letters, and special characters [!{'@'}#$%^&*()_+]",
    ...
    open_opt: {new_page: "New page opens", local_page: "Current page opens"},
    setting_email: {
        title: "Mail settings",
        host: "SMTP host",
        port: "SMTP port",
    ...
    sync_manage: {title: "Synchronous management", ds_search_placeholder: "Search name, description"},
    sync_datasource: {
    ...
    appearance: {give_up: "Give up update", save_apply: "Save and apply"},
    report: {
    ...
    variable: {give_up: "s", save_apply: "Save and apply"},
    data_fill: {
        ...
        enable: "Enable",
        enable_hint: "After data filling is enabled, the form data can be stored in the Datasource. Once enabled, it is not allowed to be closed later. ",
        new_folder: "New folder",
        ...
        enable_data_fill_hint: "After enabling, it is allowed to create a new table in the Datasource database and store the form data in the table",
        todo: "To be filled",
        finished: "Filled",
        expired: "Expired",
        ...
        form: {
            ...
            option_list_datasource_cannot_empty: "Option value binding Datasource configuration cannot be empty",
    ...
    copilot: {
        ...
        bar: "Bar chart",
        pie: "Pie chart",
        sorry: "Sorry, I can't answer this question based on the known information.Please rephrase your question or provide more information~",
    ...
    free: {
        ...
        quick_sync_tips: "All dashboards, data screens, data sets, and Datasources will be migrated to the [Migrate Resources] folder. ",
        batch_sync_tips: "1. Dashboards, data screens, data sets, and Datasources related to the selected resources will also be migrated to the [Migrate Resources] folder of the corresponding resources;",
        ...
        del_tips_datasource: "Some datasets are using these Datasources. After deletion, the datasets will be unavailable. Are you sure you want to delete it? ",
        ...
        single_del_tips_datasource: "There are {0} datasets using this Datasource. After deletion, the dataset will be unavailable. Are you sure you want to delete it? ",
        folder: "Folder",
