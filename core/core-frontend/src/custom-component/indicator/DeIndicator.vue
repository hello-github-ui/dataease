...
import {computed, CSSProperties, PropType, reactive, ref, shallowRef, toRefs} from 'vue'
...
<template>
    ...
    >
        ...
        <div>
            ...
            <span v-if="showSuffix" :style="indicatorSuffixClass">{{ suffixContent }}</span>
        </div>
        <div v-if="indicatorNameShow" :style="indicatorNameWrapperStyle">
