...
<template>
    <el-row :class="themes" class="group" @dragend="handleDragEnd" @dragstart="handleDragStart">
        ...
        <el-scrollbar ref="userViewGroup" class="group-right" height="392px" @scroll="handleScroll">
            <el-row
                v-for="chartGroupInfo in state.chartGroupList"
                v-show="chartGroupInfo.display !== 'hidden'"
