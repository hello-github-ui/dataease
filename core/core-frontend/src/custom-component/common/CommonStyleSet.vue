        ...
        <el-row class="custom-row-inner">
            <el-space wrap>
                            ...
                            >
                                <template #prefix>
                                    <el-icon :class="{ 'dark-icon': themes === 'dark' }">
                                        <Icon>
                                            <component :is="styleOptionKey.icon"></component>
                                        </Icon>
                                    </el-icon>
                                </template>
                                <el-option
                        ...
                        >
                            ...
                            >
                                <template #prefix>
                                    <el-icon :class="{ 'dark-icon': themes === 'dark' }">
                                        <Icon>
                                            <component :is="styleOptionMountedKey.icon"></component>
                                        </Icon>
                                    </el-icon>
                                </template>
                                <el-option
                ...
                <el-tooltip v-if="styleForm.textDecoration !== undefined" effect="dark" placement="bottom">
                    ...
                    >
                        <el-icon>
                            <Icon name="style-underline">
                                <styleUnderline class="svg-icon"/>
                            </Icon>
                        </el-icon>
                    </div>
                </el-tooltip>
                <template v-if="styleForm.textAlign">
                    <div :class="'custom-divider-' + themes" class="m-divider"></div>
