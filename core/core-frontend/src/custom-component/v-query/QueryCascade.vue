    ...
    >
        <template #title>
            <div class="title">
                ...
                }}<span class="tip" style="margin-left: 8px">{{ t('v_query.not_reverse_cascade') }}</span>
            </div>
        </template>
        <div class="content">
        ...
        <div v-for="(item, index) in cascadeList" :key="index" class="cascade-content">
            <div style="display: flex; align-items: center; justify-content: space-between">
                ...
                <el-button class="cascade-delete-block" text @click="deleteCascadeBlock(index)">
                    <template #icon>
            ...
            <div v-for="(ele, idx) in item" :key="ele.id" class="cascade-item">
              ...
              "
                ...
                <el-button v-show="idx !== 0" class="cascade-delete" text @click="deleteCascade(idx, item)">
                    <template #icon>
                        <Icon name="icon_delete-trash_outlined"
                        >
                            <icon_deleteTrash_outlined class="svg-icon"
