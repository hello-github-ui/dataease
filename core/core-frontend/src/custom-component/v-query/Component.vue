...
<template>
    <div ref="vQueryRef" :style="autoStyle" class="v-query-container" @keydown.stop @keyup.stop>
        <p v-if="customStyle.titleShow" :style="titleStyle" class="title">
            {{ customStyle.title }}
        </p>
        <div
            :class="[
        ...
        >
            ...
            <div class="query-fields-container">
                <div
                    ...
                    class="query-item"
                >
                    <div :style="paddingTop" class="query-field">
                        <div :style="marginRight" class="label">
                            <div v-show="customStyle.labelShow" class="label-wrapper">
                                <div :style="labelStyle" class="label-wrapper-text">
                                    <el-tooltip
                                        :content="ele.name"
                                        :show-arrow="false"
                                        effect="dark"
                            ...
                            >
                                ...
                                <el-tooltip :content="t('v_query.delete_condition')" effect="dark" placement="top">
                ...
                <div v-if="!!listVisible.length" class="query-button">
                    <el-button
