...
<template>
    <div v-if="curComponent.displayType === '8'" class="list-item top-item" @click.stop>
        <div class="label">{{ t('dynamic_time.set_default') }}</div>
        <div :class="curComponent.hideConditionSwitching && 'hide-condition_switching'" class="value">
            <div class="condition-type">
                ...
                <el-input v-model="curComponent.defaultConditionValueF" class="condition-value-input"/>
                <div class="bottom-line"></div>
            </div>
            <div v-if="[1, 2].includes(curComponent.conditionType)" class="condition-type">
        <span class="condition-type-tip">{{
                ...
                <el-input v-model="curComponent.defaultConditionValueS" class="condition-value-input"/>
                <div class="bottom-line next-line"></div>
            </div>
        </div>
    </div>
    <div v-if="curComponent.displayType === '22'" class="list-item top-item" @click.stop>
        <div class="label">
            <el-checkbox
    ...
    <div v-if="!['8', '22'].includes(curComponent.displayType)" class="list-item">
        ...
        >
            <div class="setting">
                <el-radio-group v-model="curComponent.timeType" @change="handleTimeTypeChange">
            ...
            <template v-if="dynamicTime && curComponent.displayType === '1'">
                <div class="setting">
                    ...
                    <div class="setting-value select">
                        <el-select v-model="curComponent.relativeToCurrent" @focus="handleDialogClick">
                            <el-option
                ...
                <div v-if="curComponent.relativeToCurrent === 'custom'" class="setting">
                    <div
                    ...
                    >
                        <el-input-number
                            ...
                            step-strictly
                        />
                        <el-select v-model="curComponent.relativeToCurrentType" @focus="handleDialogClick">
                            <el-option
                        ...
                        <el-select v-model="curComponent.around" @focus="handleDialogClick">
                            <el-option
            ...
            <template v-else-if="dynamicTime && curComponent.displayType === '7'">
                <div class="setting">
                    ...
                    <div class="setting-value select">
                        <el-select v-model="curComponent.relativeToCurrentRange" @focus="handleDialogClick">
                            <el-option
                ...
                >
                    ...
                    <div class="setting-input with-date range">
                        <el-input-number
                            ...
                            step-strictly
                        />
                        <el-select v-model="curComponent.relativeToCurrentTypeRange" @focus="handleDialogClick">
                            <el-option
                                v-for="item in relativeToCurrentTypeList"
                                :key="item.value"
                                :label="item.label"
                        ...
                        <el-select v-model="curComponent.aroundRange" @focus="handleDialogClick">
                            <el-option
                                v-for="item in aroundList"
                                :key="item.value"
                                :label="item.label"
        ...
        <div v-if="curComponent.defaultValueCheck" :class="dynamicTime && 'setting'" class="parameters">
            <div v-if="dynamicTime" class="setting-label">{{ t('template_manage.preview') }}</div>
            <div :class="dynamicTime ? 'setting-value' : 'w100'">
                <component :is="filterTypeCom" ref="inputCom" :config="curComponent" isConfig></component>
            </div>
        </div>
    </div>
</template>
