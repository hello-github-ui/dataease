...
import {computed, defineAsyncComponent, nextTick, provide, reactive, ref, shallowRef, toRefs, unref, watch} from 'vue'
...
import {getAround, getCustomRange, getLastStart, getThisEnd, getThisStart} from './time-format-dayjs'
import {snapshotStoreWithOut} from '@/store/modules/data-visualization/snapshot'
import {useI18n} from '@/hooks/web/useI18n'
import {fieldType} from '@/utils/attr'
import {ElMessage, ElMessageBox, ElSelect} from 'element-plus-secondary'
...
<template>
    ...
    >
        <div class="container" @click="handleDialogClick">
            <div class="query-condition-list">
                ...
                <draggable :list="conditions" handle=".handle" tag="div">
                            ...
                            >
                                <el-icon class="handle">
                                    <Icon name="icon_drag_outlined">
                                        <icon_drag_outlined class="svg-icon"/>
                                    </Icon>
                                </el-icon>
                                <div :title="element.name" class="label flex-align-center icon">
                                    <el-icon
                                ...
                                <div class="condition-icon flex-align-center">
                                    ...
                                    <el-icon
                                        ...
                                        @click.stop="element.visible = !element.visible"
                                    >
                                        <Icon name="de_pwd_invisible">
                                            <de_pwd_invisible class="svg-icon"/>
                                        </Icon>
                                    </el-icon>
                                </div>
                                <div v-if="activeConditionForRename.id === element.id" class="rename" @click.stop>
                                    <el-input
                                        :ref="setRenameInput"
            ...
            <div v-if="!!curComponent" :class="curComponent.auto && 'hidden'" class="chart-field">
                <el-scrollbar>
                    <div v-if="curComponent.auto" class="mask"></div>
                    <div class="title flex-align-center">
                        {{ t('v_query.chart_and_field') }}
                        <el-radio-group v-model="curComponent.auto" class="ml-4 larger-radio">
                            ...
                            fieldType[
                              getDetype(
                                ...
                                Object.values(field.fields)
                                    ...
                                    <template #header>
                                        <el-tabs v-model="field.activelist" class="params-select--header" stretch>
                                            <el-tab-pane
                            ...
                            fieldType[
                              getDetype(
                                ...
                                Object.values(field.fields)
                                    ...
                                    <template #header>
                                        <el-tabs v-model="field.activelist" class="params-select--header" stretch>
                                            <el-tab-pane :label="t('chart.dimension')"
                                                         name="dimensionList"></el-tab-pane>
                                            <el-tab-pane
                        ...
                        <el-icon>
                          <Icon>
                            <icon_edit_outlined class="svg-icon"></icon_edit_outlined>
                                ...
                                <span v-else style="width: 172px; margin-left: 12px"></span>
                            </div>
                        </el-checkbox-group>
                    </div>
                </el-scrollbar>
            ...
            >
                <el-scrollbar>
                    <div v-if="curComponent.auto" class="mask condition"></div>
                    <div class="title flex-align-center">
            ...
            "
                    ...
                    "
                        ...
                        <div v-if="curComponent.displayType === '9'" class="list-item">
                            <div :title="t('v_query.of_option_values')" class="label ellipsis">
                                {{ t('v_query.of_option_values') }}
                            </div>
                            <div class="value">
                                <el-radio-group v-model="curComponent.resultMode" class="larger-radio">
                            ...
                            <div class="value">
                                ...
                                >
                                    <template #default="{ node, data }">
                                        <div class="content">
                                            <el-icon v-if="!data.leaf" size="18px">
                                                <Icon>
                    ...
                    >
                        ...
                        ></Icon> </el-icon
                                        ></span>
                                        <span :title="ele.name" class="field-tree_name ellipsis">{{ ele.name }}</span>
                                        <span v-if="index === 0" class="field-relationship_chart">{{
                                                t('common.associated_chart_first')
                                            }}</span>
                                        <span v-else class="field-relationship_chart">
                      <el-button text @click="handleRelationshipChart(index)">
                        {{ t('common.associated_chart') }}
                                ...
                                <el-button v-else class="start-tree_design" text @click="startTreeDesign">
                                    <template #icon>
                                        <Icon name="icon_add_outlined">
                                            <icon_add_outlined class="svg-icon"/>
                                        </Icon>
                        ...
                        >
                            ...
                            <div class="value">
                                ...
                                <template v-if="curComponent.optionValueSource === 1">
                                    ...
                                    <div class="value ellipsis" style="display: flex; align-items: center">
                    ...
                    <span :title="t('v_query.display_field')" class="label ellipsis">{{
                                    ...
                                    >
                                        ...
                                        <div class="manual-input-container">
                                            ...
                                            <div class="select-value">
                                                ...
                                                <div v-for="(_, index) in valueSource" :key="index" class="select-item">
                                                    <el-input
                                            ...
                                            <div class="add-btn">
                                                <el-button text @click="valueSource.push('')">
                                                    <template #icon>
                                                        <Icon name="icon_add_outlined"
                                                        >
                                                            <icon_add_outlined class="svg-icon"
                                            ...
                                            <div class="manual-footer flex-align-center">
                                                <el-button @click="cancelValueSource">{{
                                                        t('chart.cancel')
                                                    }}
                                                </el-button>
                                                <el-button type="primary" @click="confirmValueSource"
                                                >{{ t('chart.confirm') }}
                                                </el-button>
                                            </div>
                                        </div>
                        ...
                        <div v-if="curComponent.displayType === '8'" class="list-item top-item">
                            <div :title="t('v_query.condition_type')" class="label ellipsis">
                                {{ t('v_query.condition_type') }}
                            </div>
                            <div class="value">
                                <div class="value">
                                    <el-radio-group v-model="curComponent.conditionType" class="larger-radio">
                                        <el-radio :label="0">{{ t('v_query.single_condition') }}</el-radio>
                                        <el-radio :disabled="!!curComponent.parameters.length" :label="1">{{
                                                t('v_query.with_condition')
                                            }}
                                        </el-radio>
                                        <el-radio :disabled="!!curComponent.parameters.length" :label="2">{{
                        ...
                        <div v-if="curComponent.displayType === '8'" style="margin-bottom: 10.5px">
                            <el-checkbox
        ...
        <template #footer>
            <div class="dialog-footer">
                ...
                <el-button type="primary" @click="confirmClick">{{ t('chart.confirm') }}</el-button>
            </div>
        </template>
    </el-dialog>
    <el-dialog v-model="timeDialogShow" :title="timeName" width="420px">
    ...
    <el-dialog v-model="numDialogShow" :title="numName" width="420px">
        <el-form label-position="top">
    ...
    <CascadeDialog ref="cascadeDialog" @saveCascade="saveCascade"></CascadeDialog>
</template>
