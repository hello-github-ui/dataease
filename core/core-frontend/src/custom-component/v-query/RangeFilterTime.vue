...
<template>
    <div class="set-time-filtering-range">
        ...
        <div v-if="timeRange.intervalType !== 'none'" class="list-item">
            ...
            <div class="setting-content">
                ...
                <template v-if="dynamicTime && timeRange.intervalType !== 'timeInterval'">
                    <div v-if="timeRange.intervalType !== 'timeInterval'" class="setting">
                        <div class="setting-label">{{ t('dynamic_time.relative') }}</div>
                        <div class="setting-value select">
                            <el-select v-model="timeRange.relativeToCurrent" :teleported="false">
                                <el-option
                    ...
                    <div v-if="timeRange.relativeToCurrent === 'custom'" class="setting">
                        <div class="setting-input">
                            <el-input-number v-model="timeRange.timeNum" :min="0" controls-position="right"/>
                            <el-select v-model="timeRange.relativeToCurrentType" :teleported="false">
                                <el-option
                            ...
                            <el-select v-model="timeRange.around" :teleported="false">
                                <el-option
                ...
                <template v-else-if="dynamicTime && timeRange.intervalType === 'timeInterval'">
                    <div class="setting">
                        <div class="setting-label">{{ t('dynamic_time.relative') }}</div>
                        <div class="setting-value select">
                            <el-select v-model="timeRange.relativeToCurrentRange" :teleported="false">
                                <el-option
                        ...
                        >
                            ...
                            <div class="setting-input range">
                                <el-input-number
                                    ...
                                    step-strictly
                                />
                                <el-select v-model="timeRange.relativeToCurrentTypeRange" :teleported="false">
                                    <el-option
                                        v-for="item in relativeToCurrentTypeList"
                                        :key="item.value"
                                        :label="item.label"
                                ...
                                <el-select v-model="timeRange.aroundRange" :teleported="false">
                                    <el-option
                                        v-for="item in aroundList"
                                        :key="item.value"
                                        :label="item.label"
            ...
            <div :class="dynamicTime && 'setting'" class="parameters">
