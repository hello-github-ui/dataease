...
<template>
    ...
    >
        <div class="cascade-content">
            ...
            <div v-for="(ele, idx) in treeList" :key="ele.id" class="cascade-item">
                <div class="label">{{ t('visualization.level') }}{{ indexNumCascade[idx] }}</div>
                <div class="item-name">
                    <el-select v-model="ele.field" style="width: 300px" value-key="id">
                        <el-option
                ...
                <el-button class="cascade-delete" text @click="deleteCascade(idx)">
                    <template #icon>
