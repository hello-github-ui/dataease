...
<template>
    <el-header :class="{ 'header-light': navigateBg && navigateBg === 'light' }" class="header-flex">
        <img v-if="navigate" :src="navigate" alt="" class="logo"/>
        <Icon v-else
        >
            <logo class="svg-icon logo" style="cursor: pointer" @click="handleIconClick"
            />
        </Icon>
        <el-menu
        ...
        <div v-if="!desktop" class="operate-setting">
            <XpackComponent jsname="c3dpdGNoZXI="/>
            <el-tooltip content="Copilot" effect="dark" placement="bottom">
                <el-icon
                ...
                >
                    <Icon name="copilot">
                        <copilot class="svg-icon" @click="handleCopilotClick"/>
                    </Icon>
                </el-icon>
            </el-tooltip>
            <CopilotCom
            ...
            />
            <el-tooltip :content="t('commons.assistant')" effect="dark" placement="bottom">
                <el-icon
                ...
                >
                    <Icon name="dv-ai">
                        <dvAi class="svg-icon" @click="handleAiClick"/>
                    </Icon>
                </el-icon>
            </el-tooltip>
            <el-tooltip :content="t('data_export.export_center')" effect="dark" placement="bottom">
                <el-icon
                ...
                >
                    ...
                    >
                        <dvPreviewDownload class="svg-icon" @click="downloadClick"
                        />
                    </Icon>
                </el-icon>
            </el-tooltip>
            ...
            >
                ...
                >
                    ...
                    >
                        <Icon>
                            <msgNotice class="svg-icon" @click="msgNoticePush"/>
                        </Icon>
                    </el-icon>
                </el-badge>
            </el-tooltip>
