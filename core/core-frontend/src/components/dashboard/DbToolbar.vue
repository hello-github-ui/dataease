...
<template>
        ...
        <div class="toolbar">
          ...
          <span id="canvas-name" class="name-area" style="height: 100%; padding: 10px">
            ...
            <template v-else>
                ...
                <div v-if="editMode === 'edit' && !batchOptStatus" class="left-area">
          <span id="canvas-name" class="name-area" @dblclick="editCanvasName">
            {{ dvInfo.name }}
          </span>
                    <div class="opt-area">
                        <el-tooltip :content="$t('visualization.undo')" effect="dark" placement="bottom">
                            <el-icon
                        ...
                        <el-tooltip :content="$t('commons.reduction')" effect="dark" placement="bottom">
                            <el-icon
                                :class="{
                ...
                <div v-if="batchOptStatus" class="left-area">
                    <el-col class="adapt-count">
                        <span>{{ t('user.selection_info', [curBatchOptComponents.length]) }}</span>
                    </el-col>
                </div>
                <div v-if="!batchOptStatus && !linkageSettingStatus" class="middle-area">
                    <component-group
                        :base-width="410"
                        :icon-name="dvView"
                        ...
                        themes="light"
                    >
                        <user-view-group :dv-model="dvModel" themes="light"></user-view-group>
                    </component-group>
                    <component-group
                        :base-width="115"
                        :icon-name="dvFilter"
                        ...
                        themes="light"
                    >
                        <query-group :dv-model="dvModel" themes="light"></query-group>
                    </component-group>
                    <component-group
                        :base-width="115"
                        :icon-name="dvText"
                        ...
                        themes="light"
                    >
                        <text-group :dv-model="dvModel" themes="light"></text-group>
                    </component-group>
                    <component-group
                        :base-width="328"
                        :icon-name="dvMedia"
                        ...
                        themes="light"
                    >
                        <media-group :dv-model="dvModel" themes="light"></media-group>
                    </component-group>
                    <component-group :base-width="115" :icon-name="dvTab" is-label themes="light" title="Tab">
                        <tabs-group :dv-model="dvModel" themes="light"></tabs-group>
                    </component-group>
                    <component-group
                        :base-width="115"
                        :icon-name="dvMoreCom"
                        ...
                        themes="light"
                    >
                        <db-more-com-group :dv-model="dvModel" themes="light"></db-more-com-group>
                    </component-group>
            ...
            <div v-if="!batchOptStatus && !linkageSettingStatus" class="right-area">
                <template v-if="editMode !== 'preview'">
                    <el-tooltip
                    ...
                    <el-tooltip :content="t('visualization.batch_opt')" effect="dark" placement="bottom">
                        <component-button
                            :icon-name="dvBatch"
                ...
                <el-dropdown v-if="editMode === 'edit'" trigger="hover">
                    ...
                    <template #dropdown>
                        <el-dropdown-menu class="drop-style">
                            <el-dropdown-item v-if="!isIframe" @click="previewInner">
                ...
                <template v-if="editMode === 'edit' || editMode === 'preview'">
                    ...
                    >
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                <el-dropdown-item v-if="dvInfo.status === 2" @click="recoverToPublished">
            ...
            <div v-if="batchOptStatus" class="right-area full-area">
                <el-button
            ...
            <div v-if="linkageSettingStatus" class="right-area full-area">
                <el-button
                    class="custom-normal-button"
                    style="float: right; margin-right: 12px"
    ...
    <de-fullscreen ref="fullScreeRef" show-position="edit"></de-fullscreen>
