...
import FilterStyleSimpleSelector
    from '@/components/dashboard/subject-setting/dashboard-style/FilterStyleSimpleSelector.vue'
        ...
        <el-row>
            <el-collapse v-model="canvasAttrActiveNames">
                <el-collapse-item :title="t('components.dashboard_style')" name="style">
                    ...
                    <el-button class="button-panel__style" size="small" text @click="saveSelfSubject">
                        {{ $t('commons.save') }}
                    </el-button>
                </el-collapse-item>
