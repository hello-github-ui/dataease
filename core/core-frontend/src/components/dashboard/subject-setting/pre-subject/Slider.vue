<template>
    <el-row style="flex-direction: column; width: 100%">
        <el-row v-loading="state.slidersLoading" style="margin-top: -4px; margin-bottom: -6px">
            ...
            <el-col :span="24">
                <el-row id="slider">
                    <div :style="slideWindowHeight" class="slider-window">
                        <ul v-if="!state.slidersLoading" :style="containerStyle" class="container">
                            <li>
                    ...
                    <li class="right" @click="move(state.sliderWidth, -1, state.speed)">
                        ...
                        >
                            <g filter="url(#filter0_d_1423_44502)">
                                <rect fill="white" height="24" rx="12" width="24" x="8" y="4"/>
                                <rect height="23" rx="11.5" stroke="#DEE0E3" width="23" x="8.5" y="4.5"/>
                            </g>
                            <path
        ...
        <div style="display: flex; margin-top: 16px">
            ...
            <div class="dot-container" style="flex: 1">
                <span hidden>B</span>
                <ul v-if="state.sliders.length > 1" class="dots">
                    <li
...
import {deleteSubject, querySubjectWithGroupApi, saveOrUpdateSubject} from '@/api/visualization/dataVisualization'
