<template>
    ...
    >
        <div>
          ...
          <span :title="t(subjectItem.name)" style="margin-top: 8px; margin-left: 8px">{{
                  t(subjectItem.name)
              }}</span>
                </div>
                <div v-if="subjectItem.type === 'self'" class="edit-area">
                    <el-tooltip :content="$t('common.delete')" effect="dark" placement="top">
                        <el-button class="m-custom-icon" text @click="subjectDelete()">
                            <el-icon size="14px">
                                <Delete/>
                            </el-icon>
                        </el-button>
                    ...
                    <el-tooltip :content="$t('common.edit')" effect="dark" placement="top">
                        <el-button class="m-custom-icon" style="margin-left: 2px" text @click="subjectEdit()">
                            <el-icon size="14px">
                                <EditPen/>
                            </el-icon>
                        </el-button>
