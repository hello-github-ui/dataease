<template>
    <el-form label-position="top">
        ...
        <el-form-item
            ...
            class="form-item"
        >
            <el-select v-model="canvasStyleData.fontFamily" :effect="themes" @change="fontFamilyChange()">
                <el-option
        ...
        <el-form-item :class="'form-item-' + themes" class="form-item" style="padding-left: 20px">
            <el-input
        ...
        <span class="data-area-label">
          ...
          <el-tooltip :effect="toolTip" class="item" placement="bottom">
            ...
            <el-radio-group
                ...
                @change="themeChange"
            >
                <el-radio :effect="themes" label="all">
        ...
        >
            <el-checkbox
                ...
                size="small"
                @change="themeChange"
            >{{ t('visualization.display_auxiliary_grid') }}
            </el-checkbox
            >
        </el-form-item>
    </el-form>
...
import {COMMON_COMPONENT_BACKGROUND_DARK, COMMON_COMPONENT_BACKGROUND_LIGHT} from '@/custom-component/component-list'
