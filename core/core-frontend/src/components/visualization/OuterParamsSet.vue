    ...
    >
        <el-row style="height: 550px">
            <el-row v-loading="state.loading">
                ...
                <el-button icon="Plus" text type="primary" @click="addOuterParamsInfo"> </el-button>
              </span>
                        </el-row>
                  ...
                  <span class="custom-tree-node" style="display: flex">
                    ...
                    <span :id="'paramName-' + data.paramsInfoId" style="flex: 1">
                      ...
                      <span v-else-if="data.paramName" class="tree-select-field">
                        {{ data.paramName }}
                      </span>
                      <span v-else class="tree-select-field"
                      >{{ t('visualization.no_setting_params_name_tip') }}
                      </span>
                    </span>
                    <span v-if="!(curEditDataId === data.paramsInfoId)" class="icon-more">
                      <handle-more
                    ...
                    <el-col :span="13" class="preview-show">
                        <el-row v-if="state.curNodeId">
                            ...
                            <el-row v-if="state.outerParamsInfo?.filterInfo?.length" class="new-params-filter">
                                <div class="inner-content" style="display: flex">
                                    <div class="expand-custom-outer" style="width: 16px; margin-top: 2px">
                                ...
                                <div class="outer-filter-content">
                                    ...
                                    >
                                        ...
                                        <div style="flex: 1; line-height: 32px">
                                            ...
                                            >
                                                <filterParams class="svg-icon view-type-icon" style="margin-top: 4px"
                                                />
                                            </Icon>
                            ...
                            <el-row v-if="state.outerParamsInfo?.datasetInfo?.length" class="new-params-ds">
                                <div class="inner-content" style="display: flex">
                                    <div class="expand-custom-outer" style="width: 16px; margin-top: 2px">
                                        <div class="expand-custom">
                                ...
                                <div class="outer-dataset-content">
                                    ...
                                    >
                                        <div style="display: flex; width: 100%">
                                            <div class="expand-custom-outer" style="width: 16px; margin-top: 7px">
                                                <div class="expand-custom">
                                                    <el-icon
                                                        @click="
                            ...
                            "
                              ...
                              baseDatasetInfo.datasetFields
                                        ...
                                        <div v-show="baseDatasetInfo.viewExpand" class="ds-view-content">
