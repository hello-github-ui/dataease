...
// 透视图在预览或编辑时，右上角会有一个“查看数据”按钮，点击后会触发 userViewEnlargeOpen 事件
// 该事件会通过 ComponentWrapper.vue 组件的 @userViewEnlargeOpen 向上传递，
// 最终调用 UserViewEnlarge.vue 组件的 dialogInit 方法，弹出“查看数据”弹窗。
