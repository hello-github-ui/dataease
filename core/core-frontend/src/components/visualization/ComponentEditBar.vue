<template>
    ...
    >
            ...
            <el-icon class="bar-base-icon">
                <el-tooltip :content="t('visualization.more')" effect="dark" placement="bottom">
                    <icon name="icon_more_outlined">
                        <icon_more_outlined class="svg-icon"/>
                    </icon>
                </el-tooltip>
            </el-icon>
            <template #dropdown>
                <el-dropdown-menu>
                    <el-dropdown-item v-if="barShowCheck('copy')" @click="copyComponent">{{
              ...
              "
                        ...
                        >{{ t('visualization.show_data_info') }}
                        </el-dropdown-item
                        >
                        <el-dropdown-item
                            v-if="
              ...
              "
                            ...
                            @click.prevent
                        >
                            <el-dropdown placement="right-start" style="width: 100%" trigger="hover">
                                <div
                  ...
                  "
                    ...
                    />
                    <el-dropdown-item v-if="barShowCheck('delete')" divided @click="deleteComponent">{{
      ...
      "
            ...
            trigger="click"
        >
            <el-icon class="bar-base-icon" @click="downloadClick">
        ...
        <el-popover v-if="selectFieldShow" trigger="click" width="200" @mousedown="fieldsAreaDown">
            <template #reference>
                <el-icon class="bar-base-icon">
                    <Icon name="database">
                        <database class="svg-icon"/>
                    </Icon
                    >
                </el-icon>
            </template>
            <fields-list :element="element" :fields="state.curFields"/>
        </el-popover>
...
import {ElButton, ElMessage, ElTooltip} from 'element-plus-secondary'
