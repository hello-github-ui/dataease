<template>
    <el-dialog
        ...
        width="70vw"
    >
        <div v-if="state.initState" style="height: 550px" @keydown.stop @keyup.stop>
            ...
            ><datasetOutline class="svg-icon view-type-icon" style="vertical-align: -0.2em"
            /></Icon>
            ...
            <el-row v-loading="state.loading">
                ...
                <el-switch v-model="state.showSelected" size="small"/>
              </span>
                        </el-row>
                        <el-tree
                        ...
                        <el-container class="settings-container">
                            <el-header class="settings-header">
                                <el-form-item class="radio-group-box">
                                    ...
                                    <el-radio-group v-if="!state.linkJumpInfo" class="larger-radio" disabled>
                                        <el-radio label="outer">{{ t('visualization.link_outer') }}</el-radio>
                                ...
                                >
                                    ...
                                    <el-radio-group v-model="state.linkJumpInfo.windowSize" class="larger-radio">
                            ...
                            <el-main class="settings-main">
                                <template v-if="state.linkJumpInfo">
                                    <template v-if="state.linkJumpInfo.linkType === 'inner'">
                                        <el-form class="main-form" label-position="top">
                                            <div class="m-row">
                                                <div style="flex: 1">
                                                    <el-form-item>
                                                        <template #label>
                                                        ...
                                                        <el-select v-model="dvInfo.name" disabled style="width: 100%">
                                                            <el-option
                                                                :key="dvInfo.name"
                                                                :label="dvInfo.name"
                                                                :value="dvInfo.name"
                                                ...
                                                <div class="icon-center">
                                                    ...
                                                    >
                                                        <dvLinkTarget class="svg-icon" style="width: 20px; height: 20px"
                                                        />
                                                    </Icon>
                                                </div>
                                                <div style="flex: 1">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <dvDashboardSpine
                                                                                ...
                                                                                class="svg-icon"
                                                                            />
                                                                            <dvScreenSpine v-else
                                                                                           class="svg-icon"></dvScreenSpine>
                                                                        </Icon>
                                                                    </el-icon>
                                                                    <el-icon v-else size="18px"
                                                                             style="display: inline-block">
                                                                        <Icon name="dv-folder">
                                            ...
                                            <template v-if="state.linkJumpInfo.targetDvId">
                                                <div class="jump-com-list">
                                                    <el-tabs v-model="state.activeCollapse" size="small">
                                                        <el-tab-pane :label="t('visualization.linkage_view')"
                                                                     name="view">
                                                        </el-tab-pane>
                                                        <el-tab-pane
                            ...
                            >
                                                    ...
                                                    <template
                                                        v-else-if="state.linkJumpCurFilterFieldArray.length === 0">
                                            ...
                                            <el-col :span="16" style="height: 100%">
                                                <div class="url-text">
                                                    ...
                                                    <el-tooltip class="item" effect="dark" placement="bottom">
                                                        ...
                                                        <el-icon class="hint-icon" size="16px">
                                            ...
                                            <el-col :span="8" style="height: 100%">
                                                ...
                                                <div class="outer-content-right">
                                                    <el-input
                                                        ...
                                                        clearable
                                                    />
                                                    <el-scrollbar height="250px" style="margin-top: 12px">
                            <span
