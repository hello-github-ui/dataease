<template>
    <el-form :label-width="14" label-position="left">
        <el-row v-for="(x, i) in positionKeysGroup" :key="i" :gutter="8">
            <el-col v-for="({ key, label, min, max, step }, j) in x" :key="j" :span="12">
                <el-form-item :class="'form-item-' + themes" :label="label" class="form-item">
                    <el-input-number
        ...
        <el-row v-if="curComponent && curComponent.multiDimensional">
            <el-col :span="12">
                ...
                <template v-if="curComponent.multiDimensional.enable">
                    <el-form-item :class="'form-item-' + themes" class="form-item" label="X">
                        <el-input-number
                    ...
                    <el-form-item :class="'form-item-' + themes" class="form-item" label="Y">
                        <el-input-number
                    ...
                    <el-form-item :class="'form-item-' + themes" class="form-item" label="Z">
                        <el-input-number
