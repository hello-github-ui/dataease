          ...
          >
            ...
            <el-row>
                ...
                <el-switch v-model="state.showSelected" size="small"/>
                        ...
                        <el-row v-show="sameDsShow" class="tree-dataset-head"
                        ><span
                  ...
                  <span>
                    <span class="tree-select-field">
                      ...
                      {{ data.targetViewName }}
                        ...
                        <el-row v-show="diffDsShow" class="tree-dataset-head tree-dataset-head-top"
                        ><span
              ...
              "
                        ...
                        >
                            <Icon name="dv-empty"
                            >
                                <dvEmpty class="svg-icon" style="width: 125px; height: 125px"
                                />
                            </Icon>
                              ...
                              <span style="float: left; margin-left: 4px; font-size: 14px">{{
                                      item.name
                                        ...
                                        <el-icon class="link-icon-join">
                                            <Icon name="dv-link-target" style="width: 20px; height: 20px"
                                            >
                            ...
                            <span class="custom-option">
                              ...
                              <span style="float: left; margin-left: 4px; font-size: 14px">{{
                                ...
                                <el-row style="width: 100%; padding-left: 16px">
                                    <el-button icon="Plus" text type="primary" @click="addLinkageField('', '')">
                                        {{ t('visualization.add_linkage_dependency_fields') }}
                                    </el-button>
                                </el-row>
                            </el-row>
                        </el-row>
                        <el-row v-else class="custom-position" style="height: 100%">
                            <Icon name="dv-empty"
                            >
                                <dvEmpty class="svg-icon" style="width: 125px; height: 125px"
                                />
            ...
            <el-row class="root-class">
                ...
                <el-button size="mini" type="primary" @click="saveLinkageSetting()">
                    {{ t('dataset.confirm') }}
                </el-button>
            </el-row>
        </div>
...
import {getPanelAllLinkageInfo, getViewLinkageGatherArray, saveLinkage} from '@/api/visualization/linkage'
