...
<template>
    <div
        ...
        @keydown.stop
    >
        <el-row :class="'title-' + themeInfo" align="middle" justify="space-between">
            <div
        ...
        <div v-if="!canvasCollapse[sideName]" class="main-content">
            <el-scrollbar>
                <slot/>
            </el-scrollbar>
        </div>
        <div v-if="canvasCollapse[sideName]" class="collapse-title">
            <span>{{ title }}</span>
        </div>
