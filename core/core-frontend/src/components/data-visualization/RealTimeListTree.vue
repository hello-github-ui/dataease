...
<template>
    ...
    <div class="real-time-component-list">
        <button id="close-button" hidden="true"></button>
        <div :class="{ activated: hiddenAreaActive }" class="layer-area" @click="areaClick('hidden')">
                    ...
                    areaData.components.includes(element)
                            ...
                            >
                                ...
                                <el-icon class="component-icon">
                                    <Icon>
                                        <component :is="getIconName(element)"></component>
                                    </Icon>
                                </el-icon>
                                <span
                  ...
                  activated:
                    ...
                    areaData.components.includes(getComponent(index))
                            ...
                            >
                                ...
                                <el-icon class="component-icon">
                                    <Icon>
                                        <component :is="getIconName(getComponent(index))"></component>
                                    </Icon>
                                </el-icon>
                                <span
                    ...
                    'icon-container-show': !getComponent(index)?.isShow
                                ...
                                >
                                    <el-icon
                                        ...
                                        @click="showComponent"
                                    >
                                        <Icon name="dv-eye-close">
                                            <dvEyeClose class="svg-icon opt-icon"/>
                                        </Icon>
                                    </el-icon>
                                    <el-icon
                                        v-show="getComponent(index)?.isShow"
                                    ...
                                    >
                                        <Icon name="dv-show">
                                            <dvShow class="svg-icon opt-icon"/>
                                        </Icon>
                                    </el-icon>
                                    <el-icon
                                    ...
                                    >
                                        <Icon name="dv-unlock">
                                            <dvUnlock class="svg-icon opt-icon"/>
                                        </Icon>
                                    </el-icon>
                                    <el-icon
                                        v-show="getComponent(index)?.isLock"
                                    ...
                                    >
                                        <Icon name="dv-lock">
                                            <dvLock class="svg-icon opt-icon"/>
                                        </Icon>
                                    </el-icon>
                                    <el-dropdown
                                        ref="dropdownMore"
