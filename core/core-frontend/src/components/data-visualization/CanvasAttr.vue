...
<template>
    <div class="attr-container de-collapse-style">
        <el-collapse v-model="canvasAttrActiveNames">
            <el-collapse-item :title="t('visualization.size')" effect="dark" name="size">
            ...
            <el-collapse-item :title="t('visualization.base_config')" effect="dark" name="baseSetting">
                <canvas-base-setting themes="dark"></canvas-base-setting>
            </el-collapse-item>
            <el-collapse-item :title="t('visualization.background')" effect="dark" name="background">
