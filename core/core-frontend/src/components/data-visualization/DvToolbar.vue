...
<template>
    <div ref="dvToolbarMain" class="toolbar-main">
        <div class="toolbar">
          ...
          <span id="dv-canvas-name" class="name-area" @dblclick="editCanvasName">
            {{ dvInfo.name }}
                    ...
                    <div class="opt-area">
                        <el-tooltip :content="$t('visualization.undo')" effect="ndark" placement="bottom">
                            <el-icon
                        ...
                        <el-tooltip :content="$t('commons.reduction')" effect="ndark" placement="bottom">
                            <el-icon
                                :class="{
                ...
                <div class="middle-area">
                    ...
                    <component-group :base-width="115" :icon-name="dvTab" is-label title="Tab">
