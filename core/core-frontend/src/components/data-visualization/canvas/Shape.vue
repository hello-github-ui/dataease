<template>
    ...
    >
        ...
        >
            <el-icon>
                <Icon name="icon_replace_outlined">
                    <replaceOutlined class="svg-icon"/>
                </Icon>
            </el-icon>
        </div>
        <div
        ...
        >
            <el-icon>
                <Icon name="mobile-checkbox">
                    <mobileCheckbox class="svg-icon"/>
                </Icon>
            </el-icon>
        </div>
        <div v-if="showHiddenIcon" class="del-from-mobile" @mousedown.stop="hiddenComponent">
            <el-tooltip :content="$t('visualization.hidden')" placement="bottom">
                <el-icon @click.stop>
                    <Icon name="dvHidden" @click.stop>
                        <dvHidden class="svg-icon"/>
                    </Icon>
                </el-icon>
            </el-tooltip>
        </div>
        ...
        >
            ...
            >
                <Icon v-if="shapeLock" name="dv-lock">
                    <dvLock class="svg-icon iconfont icon-suo"/>
                </Icon>
                <div :style="slotStyle" class="component-slot">
                    <slot></slot>
                </div>
                <!--边框背景-->
                <Board
