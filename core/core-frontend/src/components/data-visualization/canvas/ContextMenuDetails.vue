    ...
    <div class="context-menu-base context-menu-details" @mousedown="handleComposeMouseDown">
        <ul @mouseup="handleMouseUp">
            <template v-if="areaData.components.length">
                <li @click="componentCompose" @mousedown="handleComposeMouseDown">
          ...
          "
                ...
                <el-divider v-show="composeDivider" class="custom-divider"/>
                <template v-if="curComponent">
                    ...
                    <template v-if="!curComponent['isLock'] && curComponent.category !== 'hidden'">
                        ...
                        <li v-if="curComponent.component === 'DeTabs'" @click="customSort">
                        ...
                        />
                        <li v-show="showMoveMenu" @click="categoryChange('hidden')">
                            {{ t('visualization.move_to_pop_area') }}
                        </li>
                        <el-divider class="custom-divider"/>
                        <li v-show="curComponent['isShow']" @click="hide">{{ t('visualization.hidden') }}</li>
                        <li v-show="!curComponent['isShow'] || isGroupArea" @click="show">
