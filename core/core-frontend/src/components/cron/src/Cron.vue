...
<template>
    <div>
        ...
        <el-table
            ...
            style="width: 100%"
        >
            <el-table-column :label="t('cron.second')" prop="sVal" width="70"/>
            <el-table-column :label="t('cron.minute')" prop="mVal" width="70"/>
            <el-table-column :label="t('cron.hour')" prop="hVal" width="70"/>
            <el-table-column :label="t('cron.day')" prop="dVal" width="70"/>
            <el-table-column :label="t('cron.month')" prop="monthVal" width="70"/>
            <el-table-column :label="t('cron.week')" prop="weekVal" width="70"/>
            <el-table-column :label="t('cron.year')" prop="yearVal"/>
        </el-table>
    </div>
</template>
