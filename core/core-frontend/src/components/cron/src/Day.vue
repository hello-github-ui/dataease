...
<template>
    <div>
        <div>
            <el-radio v-model="type" border label="1" size="small">{{ t('cron.every_day') }}</el-radio>
        </div>
        <div>
            <el-radio v-model="type" border label="5" size="small">{{ t('cron.not_set') }}</el-radio>
        </div>
        <div>
            <el-radio v-model="type" border label="2" size="small">{{ t('cron.cycle') }}</el-radio>
        ...
        <div>
            <el-radio v-model="type" border label="3" size="small">{{ t('cron.repeat') }}</el-radio>
            <span style="margin-left: 10px; margin-right: 5px">{{ t('cron.from') }}</span>
            <el-input-number
        ...
        <div>
            <el-radio v-model="type" border label="8" size="small">{{ t('cron.work_day') }}</el-radio>
        ...
        <div>
            <el-radio v-model="type" border label="6" size="small">{{
                    t('cron.this_week_last_day')
                }}
            </el-radio>
        </div>
        <div>
            <el-radio v-model="type" border label="4" size="small">{{ t('cron.set') }}</el-radio>
