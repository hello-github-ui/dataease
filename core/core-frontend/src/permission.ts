...
import {getDefaultSettings, getRoleRouters} from '@/api/common'
import {useNProgress} from '@/hooks/web/useNProgress'
import {getFirstAuthMenu, pathValid, usePermissionStoreWithOut} from '@/store/modules/permission'
import {usePageLoading} from '@/hooks/web/usePageLoading'
import {useCache} from '@/hooks/web/useCache'
import {checkPlatform, isLarkPlatform, isMobile, isPlatformClient} from '@/utils/utils'
