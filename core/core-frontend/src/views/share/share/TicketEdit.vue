    ...
    >
        ...
        >
            ...
            <div class="ticket-row ticket-tips-label">
                ...
                <el-tooltip :content="t('commons.copy')" class="item" effect="dark" placement="top">
            ...
            <el-form-item :label="t('visualization.over_time')" prop="exp">
                <template v-slot:label>
                    <div class="ticket-form-info-tips">
                        <span class="custom-form-item__label">{{ t('visualization.over_time') }}</span>
                        <el-tooltip :content="t('link_ticket.time_tips')" effect="dark" placement="top">
                            <el-icon>
                                <Icon name="dv-info">
            ...
            <el-form-item :label="t('dataset.param')" class="last-form-item" prop="args">
                <template v-slot:label>
                    <div class="ticket-form-info-tips">
                        <span class="custom-form-item__label">{{ t('dataset.param') }}</span>
                        <el-tooltip :content="t('link_ticket.arg_format_tips')" effect="dark" placement="top">
                            <el-icon>
                                <Icon name="dv-info">
                                    <dvInfo class="svg-icon"/>
                                </Icon>
                ...
                <div v-for="(row, index) in state.argList" :key="index" class="args-line">
            ...
            <div class="ticket-add">
                <el-button text @click.stop="addArgRow">
                    <template #icon>
