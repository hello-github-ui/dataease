<template>
    <div class="ticket">
        ...
        <div class="ticket-add">
            <el-button text @click.stop="addRow">
                <template #icon>
        ...
        <div class="ticket-table">
            ...
            >
                <el-table-column label="Ticket" prop="ticket">
                ...
                <el-table-column :label="$t('visualization.over_time')" prop="exp">
            ...
            <span>
              {{ scope.row.exp }}
                ...
                <el-table-column :label="$t('dataset.param')" prop="args" width="117">
                    <template v-slot="scope">
                        <el-tooltip :content="scope.row.args" class="box-item" effect="light" placement="top">
              <span style="color: #3370ff">
                ...
                <el-table-column :label="$t('commons.operating')" width="80">
                    <template v-slot="scope">
                        <div class="ticket-row">
                            <el-tooltip :content="$t('commons.edit')" class="item" effect="dark" placement="top">
                            ...
                            <el-tooltip :content="t('commons.delete')" class="item" effect="dark" placement="top">
                                <el-icon
