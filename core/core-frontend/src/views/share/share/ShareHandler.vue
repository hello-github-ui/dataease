<template>
    ...
    <el-button v-if="props.weight >= 7 && props.isButton" icon="Share" @click.stop="share">{{
        ...
        <div class="share-dialog-container">
            <div class="copy-link">
                <div class="open-share flex-align-center">
                    <el-switch v-model="shareEnable" size="small" @change="enableSwitcher"/>
                    {{ shareTips }}
                </div>
                    ...
                    >
                        ...
                        <template #suffix>
                            <div class="share-input-suffix">
                                ...
                                <div v-if="!linkCustom" class="input-suffix-btn" @click="editUuid">
                                    <el-tooltip
                                ...
                                <div v-if="linkCustom" class="input-suffix-btn" @click.stop="resetUuid">
                                    <el-tooltip
                                ...
                                <div v-if="linkCustom" class="input-suffix-btn done-finish" @click="finishEditUuid">
                                    <el-tooltip
                ...
                <div v-if="shareEnable" class="exp-container">
                    ...
                    >
                        <div class="checkbox-span">
                            ...
                            <span :class="{ 'pe-tips-hidden': !sharePeRequire }" class="pe-require">
                <span>*</span>
              </span>
                        </div>
                    </el-checkbox>
                ...
                <span>*</span>
                    ...
                    <div v-if="passwdEnable" class="auto-pwd-container">
                        <el-checkbox
                            v-show="false"
                    ...
                    <div v-if="passwdEnable" class="inline-share-item">
                        <el-input
                            ref="pwdRef"
...
import {SHARE_BASE, ShareInfo, shortcuts} from './option'
import {ElLoading, ElMessage} from 'element-plus-secondary'
