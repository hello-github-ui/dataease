        ...
        <el-row v-if="previewModel === 'createPreview'" class="main-container">
            <el-row class="market-head">
                ...
                <el-row class="head-right">
                    ...
                    <el-icon class="custom-market-icon hover-icon_custom" @click="close">
                        <Close/>
                    </el-icon>
                </el-row>
            </el-row>
            <el-row class="template-area">
                <el-row class="img-main-create">
                    <img :src="curTemplateImg" alt="" style="height: 100%"/>
                </el-row>
            </el-row>
        </el-row>
            ...
            <el-row class="market-head">
                ...
                <el-row class="head-right">
                    <el-input
                        ...
                        prefix-icon="Search"
                    />
                    <el-select v-model="state.templateSourceType" class="title-type" placeholder="Select">
                        <el-option
                    ...
                    <el-select v-model="state.templateClassifyType" class="title-type" placeholder="Select">
                        <el-option
            ...
            <el-row class="template-area">
                ...
                <el-row v-show="state.networkStatus && !state.hasResult" class="template-empty">
                    <div style="text-align: center">
                        <Icon name="no_result"
                        >
                            <no_result class="svg-icon" style="margin-bottom: 16px; font-size: 75px"
                            />
                        </Icon>
                        <br/>
