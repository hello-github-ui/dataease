<template>
    <el-row style="width: 100%">
        <el-row style="display: table; width: 100%">
            <el-col :class="state.asideActive ? 'aside-active' : 'aside-inActive'" style="float: left">
                ...
                <el-row v-show="state.asideActive" style="padding: 12px 12px 0">
                    <el-row style="align-items: center">
                        <el-icon class="insert" @click="closePreview()">
                            <Close/>
                        </el-icon>
                        <span class="main-title">{{ t('visualization.template_preview') }}</span>
                        <el-icon class="insert" @click="asideActiveChange(false)">
                            <DArrowLeft/>
                        </el-icon>
                    </el-row>
            ...
            >
                ...
                <el-row class="img-main">
                    <img :src="state.templatePreviewUrl" alt="" style="height: 100%"/>
                </el-row>
            </el-col>
        </el-row>
    </el-row>
