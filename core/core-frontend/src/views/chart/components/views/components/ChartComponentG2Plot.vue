...
import {computed, nextTick, onBeforeUnmount, onMounted, reactive, ref, shallowRef, toRefs} from 'vue'
...
<template>
    <div class="canvas-area">
        ...
        />
        <div v-if="!isError" :id="containerId" ref="chartContainer" class="canvas-content"></div>
