    ...
    <div @keydown.stop @keyup.stop>
        <el-col>
            <div v-if="item.deType === 0 || item.deType === 5">
                ...
                >
                    <el-radio label="logic" style="min-width: 80px">{{ t('chart.logic_exp') }}</el-radio>
                    <el-radio label="enum" style="min-width: 80px">{{ t('chart.enum_exp') }}</el-radio>
                </el-radio-group>
            </div>
            ...
            >
                ...
                >
                    ...
                    <el-select
                        ...
                        @change="logicChange"
                    >
                        <el-option :label="t('chart.logic_and')" style="min-width: 80px" value="and"/>
                        <el-option :label="t('chart.logic_or')" style="min-width: 80px" value="or"/>
                    </el-select>
