...
<template>
    <el-col>
        <div class="tip">
            <Icon class="icon-style" name="icon_info_filled"
            >
        ...
        <div style="max-height: 50vh; overflow-y: auto" @keydown.stop @keyup.stop>
            <div
              ...
              <span style="margin: 0 -5px">
                ≤&nbsp;{{ t('chart.drag_block_label_value') }}&nbsp;≤
                      ...
                      item.dynamicMaxField
                        ...
                        <el-col :span="3">
                            <el-form-item :label="t('chart.textColor')" class="form-item">
                                <el-color-picker
                                    v-model="item.color"
                        ...
                        <el-col :span="3">
                            <el-form-item :label="t('chart.backgroundColor')" class="form-item">
                                <el-color-picker
