...
import TextLabelThresholdEdit
    from '@/views/chart/components/editor/editor-senior/components/dialog/TextLabelThresholdEdit.vue'
...
import PictureGroupThresholdEdit
    from '@/views/chart/components/editor/editor-senior/components/dialog/PictureGroupThresholdEdit.vue'
...
<template>
    <div style="width: 100%; margin-bottom: 16px" @keydown.stop @keyup.stop>
        <!--仪表盘-->
          ...
          <span :class="'label-' + props.themes" class="label">{{
            ...
            >
              <template #icon>
                ...
                >
                    <div :class="{ 'field-style-dark': themes === 'dark' }" class="field-style">
                ...
                >
                  ...
                  {{ getDynamicStyleLabel(item, item.dynamicMinField) }}≤{{
                            ...
                            <template v-if="chart.type === 'picture-group'">
                                <div class="pic-group-main" title="显示图片">
                                    <img
                                        v-if="item.url"
