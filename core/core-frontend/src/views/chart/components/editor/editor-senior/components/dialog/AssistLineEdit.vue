...
<template>
    <div>
        <div style="max-height: 50vh; margin-top: -4px; overflow-y: auto" @keydown.stop @keyup.stop>
            <el-row v-for="(item, index) in state.lineArr" :key="index" :gutter="8" class="line-item">
                <el-col :span="4">
                    <el-input
                        v-model="item.name"
              ...
              <span style="float: left">
                ...
                <el-col v-if="item.field === '1'" :span="3">
                    <el-select
                        ...
                        @change="changeAssistLine"
                    >
                        <el-option key="avg" label="平均值" value="avg"/>
                        <el-option key="max" :label="t('chart.max')" value="max"/>
                        <el-option key="min" :label="t('chart.min')" value="min"/>
                        <el-option key="last_item" :label="t('chart.last_item')" value="last_item"/>
                    </el-select>
                </el-col>
                <el-col :span="useQuotaExt ? 2 : 3">
                    <el-tooltip :content="t('chart.font_size')" effect="dark" placement="top">
                        <el-select
        ...
        <el-button class="circle-button" style="margin-left: 5px" text @click="addLine">
            <template #icon>
