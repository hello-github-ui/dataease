    ...
    <el-dropdown :effect="themes" trigger="click" @command="clickItem">
      ...
      >
        ...
        <el-tooltip :effect="toolTip" placement="top">
          ...
          <el-icon class="child remove-icon">
            <Icon
            ><icon_deleteTrash_outlined class="svg-icon inner-class" @click="removeItem"
            /></Icon>
          </el-icon>
        </el-tooltip>
      ...
      <template #dropdown>
        <el-dropdown-menu
            ...
            class="drop-style"
        >
          <el-dropdown-item v-if="showSort" @click.prevent>
            <el-dropdown
                :effect="themes"
            ...
            >
              ...
              <template #dropdown>
                ...
                >
                  <el-dropdown-item :command="beforeSort('none')" class="menu-item-padding">
                    <span
                    ...
                    >
                      ...
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'none' === item.sort" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  </el-dropdown-item>
                  <el-dropdown-item :command="beforeSort('asc')" class="menu-item-padding">
                    <span
                    ...
                    >
                      {{ t('chart.asc') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'asc' === item.sort" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  </el-dropdown-item>
                  <el-dropdown-item :command="beforeSort('desc')" class="menu-item-padding">
                    <span
                    ...
                    >
                      {{ t('chart.desc') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'desc' === item.sort" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      ...
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'custom_sort' === item.sort" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
            ...
            >
              ...
              <template #dropdown>
                <el-dropdown-menu
                    ...
                    class="drop-style sub"
                >
                  <el-dropdown-item :command="beforeDateStyle('y')" class="menu-item-padding">
                    <span
                    ...
                    >
                      {{ t('chart.y') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'y' === item.dateStyle" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.y_Q') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'y_Q' === item.dateStyle" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  </el-dropdown-item>
                  <el-dropdown-item :command="beforeDateStyle('y_M')" class="menu-item-padding">
                    <span
                    ...
                    >
                      {{ t('chart.y_M') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'y_M' === item.dateStyle" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.y_W') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'y_W' === item.dateStyle" name="icon_done_outlined">
                          <icon_done_outlined class="svg-icon"/>
                        </Icon>
                      </el-icon>
                    </span>
                  </el-dropdown-item>
                  <el-dropdown-item :command="beforeDateStyle('y_M_d')" class="menu-item-padding">
                    <span
                    ...
                    >
                      {{ t('chart.y_M_d') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'y_M_d' === item.dateStyle" name="icon_done_outlined">
                          <icon_done_outlined class="svg-icon"/>
                        </Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.H_m_s') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'H_m_s' === item.dateStyle" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.y_M_d_H') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'y_M_d_H' === item.dateStyle" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.y_M_d_H_m') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'y_M_d_H_m' === item.dateStyle" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.y_M_d_H_m_s') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'y_M_d_H_m_s' === item.dateStyle" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
          ...
          <el-dropdown-item v-if="item.deType === 1" @click.prevent>
            <el-dropdown
                :effect="themes"
                placement="right-start"
                popper-class="data-dropdown_popper_mr9"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'date_sub' === item.datePattern" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      ...
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'date_split' === item.datePattern" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
          ...
          <el-dropdown-item :command="beforeClickItem('remove')" class="menu-item-padding" divided>
            <el-icon>
