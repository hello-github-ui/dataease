...
import {notSupportAccumulateViews, quotaViews} from '@/views/chart/components/js/util'
    ...
    <el-dropdown :effect="themes" trigger="click" @command="clickItem">
      ...
      <template #dropdown>
        ...
        >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'sum' === item.summary" name="icon_done_outlined"
                  ...
                  >
                    ...
                    >
                      {{ t('chart.avg') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'avg' === item.summary" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.max') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'max' === item.summary" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.min') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'min' === item.summary" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.stddev_pop') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'stddev_pop' === item.summary" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.var_pop') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'var_pop' === item.summary" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  </el-dropdown-item>
                  <el-dropdown-item :command="beforeSummary('count')" class="menu-item-padding">
                    <span
                    ...
                    >
                      {{ t('chart.count') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'count' === item.summary" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      ...
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'count_distinct' === item.summary" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
            ...
            >
              ...
              <template #dropdown>
                <el-dropdown-menu
                    ...
                    class="drop-style sub"
                >
                  <el-dropdown-item :command="beforeQuickCalc('none')" class="menu-item-padding">
                    <span
                    ...
                    >
                      {{ t('chart.none') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'none' === item.compareCalc.type" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </span>
                  ...
                  >
                    ...
                    >
                      {{ t('chart.percent') }}
                      <el-icon class="sub-menu-content--icon">
                        <Icon v-if="'percent' === item.compareCalc.type" name="icon_done_outlined"
                        ><icon_done_outlined class="svg-icon"
                        /></Icon>
                      </el-icon>
                    </div>
          ...
          <el-dropdown-item v-if="showSort" :divided="chart.type !== 'table-info'" @click.prevent>
            <el-dropdown
                :effect="themes"
                placement="right-start"
                popper-class="data-dropdown_popper_mr9"
          ...
          <el-dropdown-item :command="beforeClickItem('rename')" class="menu-item-padding">
            <el-icon>
          ...
          <el-dropdown-item :command="beforeClickItem('remove')" class="menu-item-padding">
            <el-icon>
