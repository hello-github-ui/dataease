        ...
        >
            <template #reference>
                <el-form ref="formRef" :model="form">
                    <el-form-item :rules="rules" prop="name">
                        <el-input
            ...
            <template #default>
                <el-container :class="themes">
                    <el-header>
                        <div :class="{ dark: themes === 'dark' }" class="m-title">
                            <div>{{ sourceName }}</div>
                            <el-button class="refresh-btn" link type="primary" @click="refresh">
                                {{ t('commons.refresh') }}
                            </el-button>
                        </div>
                        <el-input
                    ...
                    <el-main :class="{ dark: themes === 'dark' }">
                        <el-scrollbar always max-height="252px">
                            <div v-if="loadingDatasetTree" v-loading="loadingDatasetTree" class="m-loading"></div>
                            <div v-if="showEmptyInfo" class="empty-info">{{ emptyMsg }}</div>
                            ...
                            >
                                <template #default="{ node, data }">
                                    ...
                                    >
                                        ...
                                        <el-icon v-if="_modelValue === data.id" class="checked-item">
                    ...
                    <el-footer v-if="!isDataEaseBi">
                        <div class="footer-container">
                            <el-button :icon="Plus" class="add-btn" link type="primary" @click="addDataset">
                                {{ newSource }}
                            </el-button>
                        </div>
                    </el-footer>
