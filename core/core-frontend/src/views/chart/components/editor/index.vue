...
import {ElIcon, ElMessage, ElTreeSelect} from 'element-plus-secondary'
...
import {cloneDeep, concat, debounce, forEach, get, keys, set} from 'lodash-es'
...
import {copyChartField, deleteChartField, Field, getFieldByDQ} from '@/api/chart'
...
<template>
    <div :class="'editor-' + themes" class="chart-edit" @keydown.stop @keyup.stop>
        <!--移动端设计使用 注意与pc设计同步-->
        ...
        <template v-if="!mobileInPc">
            ...
            'content-area-left-open': !canvasCollapse.chartAreaCollapse
                ...
                >
                    ...
                    <div v-if="!canvasCollapse.chartAreaCollapse" class="view-panel-row" style="width: 240px">
                        <el-row class="editor-title">
                            <div style="display: flex; align-items: center; width: calc(100% - 24px)">
                                ...
                                <el-popover :offset="8" placement="bottom" show-arrow trigger="click" width="200">
                                    <template #reference>
                        ...
                        <el-row :style="elRowStyle">
                            ...
                            <el-tabs
                                ...
                                class="tab-header"
                            >
                                <el-tab-pane :label="t('chart.chart_data')" class="padding-tab" name="data">
                                    <el-container direction="vertical">
                          ...
                          <span class="data-area-label">
                            ...
                            <span>
                              ...
                              ></i>
                                                    ...
                                                    >
                                                        ...
                                                        <drag-placeholder :drag-list="view.xAxis" :themes="themes"/>
                                                    </div>
                                                </el-row>
                            ...
                            <span>
                              ...
                              ></i>
                                                ...
                                                <!--flowMapStartName-->
                                                <el-row v-if="showAxis('flowMapStartName')"
                            ...
                            <span>
                              ...
                              ></i>
                                                    ...
                                                    >
                                                        ...
                                                        <drag-placeholder :drag-list="view.flowMapStartName"
                                                                          :themes="themes"/>
                                                    </div>
                                                </el-row>
                            ...
                            <span>
                              ...
                              ></i>
                                                    ...
                                                    >
                                                        ...
                                                        <drag-placeholder :drag-list="view.flowMapEndName"
                                                                          :themes="themes"/>
                                                    </div>
                                                </el-row>
                            ...
                            <span>
                              ...
                              ></i>
                                                    ...
                                                    >
                                                        ...
                                                        <drag-placeholder :drag-list="view.extColor" :themes="themes"/>
                                                    </div>
                                                </el-row>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    /></Icon>
                                                    ...
                                                    <!-- xAxisExtRight -->
                                                    <el-row v-if="showAxis('xAxisExtRight')"
                                                            class="padding-lr drag-data">
                                                        <div class="form-draggable-title">
                              <span>
                            ...
                            <span>
                              {{ t('chart.result_filter') }}
                                        ...
                                        <el-footer :class="{ 'refresh-active-footer': view.refreshViewEnable }">
                                            ...
                                            <el-row :class="'result-style-' + themes" class="result-style">
                                                <div class="result-style-input">
                          <span v-if="view.type !== 'richTextView'">
                            {{ t('chart.result_count') }}
                          </span>
                                                    <span v-if="view.type !== 'richTextView'" style="padding-left: 8px">
                            <el-radio-group
                                ...
                                @change="recordSnapshotInfo('render')"
                            >
                              <el-radio :effect="themes" class="margin20-radio" label="all">
                                <span
                                    :class="{ dark: themes === 'dark' }"
            ...
            'content-area-right-open': !canvasCollapse.datasetAreaCollapse
                ...
                >
                    ...
                    >
                        ...
                        <el-main class="dataset-main-top">
                            <el-row class="dataset-select">
                                ...
                                >
                                    <el-icon
                                        ...
                                        @click="editDs"
                                    >
                                        <Icon class="el-icon-arrow-down el-icon-delete" name="icon_edit_outlined"
                                        >
                            ...
                            <el-row class="dataset-search padding-lr">
                                <div :class="{ dark: themes === 'dark' }" class="dataset-search-label">
                    ...
                    >
                      ...
                      >
                        <Icon class="el-icon-arrow-down el-icon-delete" name="icon_refresh_outlined"
                    ...
                    >
                      <Icon class="el-icon-arrow-down el-icon-delete" name="icon_add_outlined"
                            ...
                            <el-icon class="icon-setting"><Setting/></el-icon>
                                                    ...
                                                    <template #dropdown>
                                                        <el-dropdown-menu :effect="props.themes">
                                                            <el-dropdown-item
                                                                :command="handleChartFieldEdit(element, 'copy')">
                                                                {{ t('common.copy') }}
                                                            </el-dropdown-item>
                              ...
                              <span class="el-dropdown-link">
                                <el-icon class="icon-setting"><Setting/></el-icon>
                                                            ...
                                                            <template #dropdown>
                                                                <el-dropdown-menu :effect="props.themes">
                                                                    <el-dropdown-item
                                                                        :command="handleChartFieldEdit(ele, 'copy')">
                                                                        {{ t('common.copy') }}
                                                                    </el-dropdown-item>
        ...
        <el-dialog
            ...
            width="420px"
        >
            <value-formatter-edit :chart="view" :formatter-item="state.valueFormatterItem"/>
            <template #footer>
                <div class="dialog-footer">
