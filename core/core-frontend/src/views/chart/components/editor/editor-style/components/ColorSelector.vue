...
import {COLOR_CASES, COLOR_PANEL, DEFAULT_COLOR_CASE} from '@/views/chart/components/editor/util/chart'
            ...
            <el-form-item :label="t('chart.color_case')" class="form-item">
              ...
              />
                    ...
                    />
                            ...
                            <el-button size="small" style="margin-left: 2px" type="text" @click="resetCustomColor"
                            >{{ t('chart.reset') }}
                            </el-button>
                        </div>
                        <!--自定义配色方案-->
