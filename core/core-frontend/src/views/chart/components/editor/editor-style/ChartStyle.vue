...
import BulletTargetSelector
    from '@/views/chart/components/editor/editor-style/components/bullet/BulletTargetSelector.vue'
import BulletMeasureSelector
    from '@/views/chart/components/editor/editor-style/components/bullet/BulletMeasureSelector.vue'
            ...
            <el-row class="de-collapse-style">
                <el-collapse v-model="state.attrActiveNames" class="style-collapse">
                    ...
                    <div v-if="showProperties('bullet-graph-selector')">
                        <el-collapse-item :effect="themes" :title="t('chart.progress_target')" name="bullet">
                        ...
                        <el-collapse-item :effect="themes" :title="t('chart.progress_current')" name="measure">
