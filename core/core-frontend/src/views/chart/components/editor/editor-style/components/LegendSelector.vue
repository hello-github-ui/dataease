...
import {COLOR_PANEL, DEFAULT_LEGEND_STYLE, DEFAULT_MISC} from '@/views/chart/components/editor/util/chart'
...
<template>
    ...
    >
        <el-row :gutter="8">
            ...
            <el-col :span="12">
                <el-form-item v-if="showProperty('icon')" :class="'form-item-' + themes" class="form-item">
        ...
        <el-form-item v-if="showProperty('showRange')" :class="'form-item-' + themes" class="form-item">
            <el-checkbox
        ...
        >
            <el-form-item :class="'form-item-' + themes" :label="t('chart.icon')" class="form-item">
                <el-select
            ...
            <el-form-item :class="'form-item-' + themes" class="form-item" style="padding-left: 8px">
                <template #label>&nbsp;</template>
                <el-select
            ...
            <div v-if="chartType === 'map'">
                ...
                <div v-if="!state.legendForm.miscForm.mapAutoLegend">
                    ...
                    <div v-if="state.legendForm.miscForm.mapLegendRangeType === 'custom'">
                        ...
                        >
                            <el-col :span="8">
                                <label :title="getMapCustomRange(index)" class="ed-form-item__label text_ellipsis">
                    ...
                    <el-row v-if="state.legendForm.miscForm.mapLegendRangeType === 'quantize'" :gutter="8">
                        <el-col :span="12">
                            <el-form-item
                                :class="'form-item-' + themes"
                                :label="t('chart.min')"
        ...
        <el-space>
            ...
            >
                ...
                >
                    ...
                    <el-radio :disabled="state.legendForm.vPosition === 'center'" label="center">
                        <el-tooltip :effect="toolTip" placement="top">
                            <template #content>
            ...
            >
                ...
                >
                    ...
                    <el-radio :disabled="state.legendForm.hPosition === 'center'" label="center">
                        <el-tooltip :effect="toolTip" placement="top">
                            <template #content>
                                {{ t('chart.text_pos_center') }}
                            </template>
