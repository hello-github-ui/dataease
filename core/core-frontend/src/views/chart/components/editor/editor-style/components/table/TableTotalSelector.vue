...
import {inject, nextTick, onMounted, PropType, reactive, ref, watch} from 'vue'
import {useI18n} from '@/hooks/web/useI18n'
import {DEFAULT_BASIC_STYLE, DEFAULT_TABLE_TOTAL} from '@/views/chart/components/editor/util/chart'
    ...
    <el-form ref="tableTotalForm" :model="state.tableTotalForm" label-position="top">
        ...
        <div v-show="showProperty('row') && state.tableTotalForm.row.showGrandTotals">
            ...
            >
                ...
                <el-col :offset="2" :span="state.rowTotalItem.aggregation === 'CUSTOM' ? 8 : 11">
                    <el-select
            ...
            "
                ...
                <el-col v-if="state.rowTotalItem.aggregation === 'CUSTOM'" :offset="1" :span="2">
                    <el-icon>
                        <Setting
                            @click="
                editField(
        ...
        <div v-if="showProperty('row') && state.tableTotalForm.row.showSubTotals">
            ...
            >
                ...
                <el-col :offset="2" :span="state.rowSubTotalItem.aggregation === 'CUSTOM' ? 8 : 11">
                    <el-select
            ...
            "
                ...
                <el-col v-if="state.rowSubTotalItem.aggregation === 'CUSTOM'" :offset="1" :span="2">
                    <el-icon>
                        <Setting
                            @click="
                editField(
        ...
        <div v-show="showProperty('col') && state.tableTotalForm.col.showGrandTotals">
            ...
            >
                ...
                <el-col :offset="2" :span="state.colTotalItem.aggregation === 'CUSTOM' ? 8 : 11">
                    <el-select
            ...
            "
                ...
                <el-col v-if="state.colTotalItem.aggregation === 'CUSTOM'" :offset="1" :span="2">
                    <el-icon>
                        <Setting
                            @click="
                editField(
        ...
        <div v-show="showProperty('col') && state.tableTotalForm.col.showSubTotals">
            ...
            >
                ...
                <el-col :offset="2" :span="state.colSubTotalItem.aggregation === 'CUSTOM' ? 8 : 11">
                    <el-select
            ...
            "
                ...
                <el-col v-if="state.colSubTotalItem.aggregation === 'CUSTOM'" :offset="1" :span="2">
                    <el-icon>
                        <Setting
                            @click="
                editField(
