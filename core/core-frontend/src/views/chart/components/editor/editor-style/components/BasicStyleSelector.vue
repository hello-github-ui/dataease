...
<template>
    <div style="width: 100%">
        ...
        >
            ...
            >
                <el-radio :effect="themes" label="col">{{ t('chart.quota_position_col') }}</el-radio>
                <el-radio :effect="themes" label="row">{{ t('chart.quota_position_row') }}</el-radio>
            </el-radio-group>
        </el-form-item>
        <el-form-item
        ...
        <div v-if="showProperty('mapBaseStyle') || showProperty('heatMapStyle')" class="map-style">
            ...
            <div v-if="mapType !== 'tianditu'" class="alpha-setting">
                <label :class="{ dark: 'dark' === themes }" class="alpha-label">
