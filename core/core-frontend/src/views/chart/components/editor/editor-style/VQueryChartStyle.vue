      ...
      "
        ...
        <el-row class="de-collapse-style">
            <el-collapse v-model="styleActiveNames" class="style-collapse">
                <el-collapse-item :effect="themes" :title="t('chart.basic_style')" name="basicStyle">
                    <el-form label-position="top" @keydown.stop.prevent.enter>
                        ...
                        >
                            ...
                            >
                                <el-radio :effect="themes" :label="true" style="min-width: 80px">{{
                                        t('visualization.to_top')
                                    }}
                                </el-radio>
                                <el-radio :effect="themes" :label="false" style="min-width: 80px">{{
                ...
                <el-collapse-item :effect="themes" :title="t('v_query.query_condition')" name="addition">
                    <el-form label-position="top" style="padding-bottom: 8px" @keydown.stop.prevent.enter>
                        <el-row :gutter="8">
                            <el-col :span="12">
                                <el-form-item
                                    :class="'form-item-' + themes"
                ...
                >
                    ...
                    >
                        <el-form-item
                            ...
                            class="form-item"
                        >
                            <el-radio-group v-model="chart.customStyle.component.layout" :effect="themes">
                                <el-radio :effect="themes" label="vertical">
                                    {{ t('visualization.condition_top') }}
                                </el-radio>
                                <el-radio :effect="themes" label="horizontal">
                ...
                <el-collapse-item :effect="themes" :title="t('commons.button')" name="button">
                    <el-form label-position="top" style="padding-bottom: 8px" @keydown.stop.prevent.enter>
                        <el-form-item
                            :class="'form-item-' + themes"
                            :effect="themes"
                            ...
                            class="form-item"
                        >
                            <el-checkbox-group v-model="chart.customStyle.component.btnList" :effect="themes">
                                <el-checkbox :effect="themes" class="checkbox-with_icon" label="sure" size="small">
                                ...
                                <br/>
                                <el-checkbox :effect="themes" label="clear" size="small" style="margin-top: 8px">
                                    {{ t('commons.clear') }}
                                </el-checkbox>
                                <br/>
                                <el-checkbox :effect="themes" label="reset" size="small" style="margin-top: 8px">
