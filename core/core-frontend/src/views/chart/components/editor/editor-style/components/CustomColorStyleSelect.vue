    ...
    >
        <el-row>
            ...
            >
                ...
                >
                    <template #reference>
                        <el-input :effect="themes" class="custom-color-selector" readonly>
                            <template #prefix>
                      ...
                      backgroundColor: c
                            ...
                            <template #suffix>
                                <el-icon :class="{ reverse: _popoverShow }" class="input-arrow-icon">
                                    <ArrowDown/>
                                </el-icon>
                            </template>
                        </el-input>
        ...
        <template v-if="customColorExtendSettingOpened">
            <div :class="{ dark: 'dark' === themes }" class="custom-color-extend-setting">
                {{ t('chart.custom_case') }}
            ...
            >
              ...
              active: item.id === seriesColorState.curSeriesColor?.id
                ...
                backgroundColor: item.color
                    ...
                    <span :class="themes === 'dark' ? 'dark' : ''" :title="item.name" class="color-item-name">
            {{ item.name }}</span
                    >
                </div>
            </div>
        </template>
        <teleport :to="seriesColorState.seriesColorPickerId" defer>
