import type {FeatureCollection, ViewLevel} from '@antv/l7plot/dist/esm/plots/choropleth/types'
...
import {AntVAbstractChartView, AntVDrawOptions, ChartLibraryType} from '@/views/chart/components/js/panel/types'
