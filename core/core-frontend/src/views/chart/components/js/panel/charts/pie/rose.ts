...
import {Rose as G2Rose, RoseOptions} from '@antv/g2plot/esm/plots/rose'
import {PIE_AXIS_CONFIG, PIE_AXIS_TYPE, PIE_EDITOR_PROPERTY, PIE_EDITOR_PROPERTY_INNER} from './common'
import {
