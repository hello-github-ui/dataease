import {G2PlotChartView, G2PlotDrawOptions} from '@/views/chart/components/js/panel/types/impl/g2plot'
...
import {cloneDeep, defaults, defaultsDeep, defaultTo, filter, isEmpty, map, union} from 'lodash-es'
...
import {DEFAULT_BASIC_STYLE, DEFAULT_LABEL, DEFAULT_LEGEND_STYLE} from '@/views/chart/components/editor/util/chart'
