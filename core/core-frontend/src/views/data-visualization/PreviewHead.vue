...
<template>
    <div class="preview-head flex-align-center">
        ...
        <el-divider direction="vertical" style="margin: 0 16px 0 7px"/>
        <div class="create-area flex-align-center">
      <span style="line-height: 22px"
      >{{ t('visualization.creator') }}:{{ dvInfo.creatorName }}</span
      >
            <el-popover :offset="8" placement="bottom" show-arrow trigger="hover" width="400">
                <template #reference>
        ...
        <div class="canvas-opt-button">
            ...
            >
            <el-button :disabled="dvInfo.status === 0" secondary @click="preview()">
                <template #icon>
            ...
            />
            <el-button v-if="dvInfo.weight > 6" class="custom-button" type="primary" @click="dvEdit()">
                <template #icon>
            ...
            <el-dropdown :disabled="dvInfo.status === 0" popper-class="pad12" trigger="click">
                <el-icon class="head-more-icon">
                    <Icon name="dv-head-more">
                        <dvHeadMore class="svg-icon"/>
                    </Icon>
                </el-icon>
                <template #dropdown>
                    <el-dropdown-menu>
                        ...
                        >
                            <div class="ed-dropdown-menu__item flex-align-center icon">
                                ...
                                <el-icon class="arrow-right_icon" color="#646A73" size="16">
                                    <ArrowRight/>
                                </el-icon>
                            </div>
                            <template #dropdown>
