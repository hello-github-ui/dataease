...
import {decompressionPre, findDragComponent, findNewComponent, initCanvasData, onInitReady} from '@/utils/canvasUtils'
...
<template>
    ...
    >
        ...
        >
            ...
            <!-- 中间画布 -->
            <main id="dv-main-center" ref="canvasCenterRef" class="center">
                <div class="de-ruler-icon-outer">
                    <el-icon class="de-ruler-icon">
                        <Icon name="dv-ruler">
                            <dvRuler class="svg-icon"/>
                        </Icon>
                    </el-icon>
                </div>
            ...
            <!-- 右侧侧组件列表 -->
            <div ref="leftSidebarRef" style="width: auto; height: 100%">
