...
import {backCanvasData, canvasSave, findComponentById} from '@/utils/canvasUtils'
    ...
    <div class="mobile-config-panel">
        <div class="top-bar">
            ...
            <div class="mobile-save">
                ...
                <el-switch v-model="dvInfo.mobileLayout" size="small"/>
                <span class="open-mobile-line"></span>
                <el-tooltip :offset="14" content="切换至PC端布局" effect="dark" placement="bottom">
                    <el-icon class="switch-pc" @click="handleBack">
        ...
        <div v-if="mobileStyle" :style="mobileStyle" class="mobile-canvas">
            ...
            <div v-loading="mobileLoading" class="config-panel-content">
        ...
        <div class="mobile-com-list">
            ...
            <el-tabs v-model="activeCollapse" size="small">
            ...
            <template v-if="!mobileLoading">
                <div v-show="activeCollapse === 'style'" class="config-mobile-tab">
                    <MobileBackgroundSelector @styleChange="changeTimes++"></MobileBackgroundSelector>
                </div>
                <div v-show="activeCollapse === 'componentStyle'" class="config-mobile-tab-style">
                    <component-style-editor
                        :canvas-view-info-mobile="canvasViewInfoMobile"
                    ></component-style-editor>
                </div>
                <div v-show="activeCollapse === 'com'" class="config-mobile-tab">
                    <div
              ...
              <span v-show="item.component === 'DeStreamMedia'" style="color: #909399">{{
                      t('visualization.mobile_ios_tips')
                        ...
                        <div v-if="!mobileLoading" class="pc-select-to-mobile" @click="addToMobile(item)"></div>
                    </div>
                </div>
            </template>
        </div>
