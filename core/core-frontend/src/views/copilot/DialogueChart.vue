...
import {computed, nextTick, onMounted, PropType, ref, shallowRef, watch} from 'vue'
...
<template>
    ...
    >
        <el-icon class="dialogue-chart_icon" style="font-size: 32px">
            <Icon
            >
                <component
        ...
        >
            <template v-if="!renderTable">
                ...
                <el-tooltip :content="t('copilot.switch_chart')" effect="dark" placement="top">
                    <div
            ...
            <el-tooltip :content="t('copilot.switch_table')" effect="dark" placement="top">
                <el-icon
                    :class="(renderTable || renderTableLocal) && 'active'"
                    class="ed-icon_chart"
                ...
                >
                    <Icon name="chart-table">
                        <chartTable class="svg-icon"/>
                    </Icon>
                </el-icon>
            </el-tooltip>
            <el-divider direction="vertical"/>
            <el-tooltip :content="t('copilot.download')" effect="dark" placement="top">
                <el-icon class="ed-icon_chart" @click="downloadChart">
                    <Icon name="chart-download">
                        <chartDownload class="svg-icon"/>
                    </Icon>
                </el-icon>
            </el-tooltip>
        </div>
