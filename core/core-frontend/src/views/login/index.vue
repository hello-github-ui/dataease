...
import {ElMessage, FormInstance, FormRules} from 'element-plus-secondary'
import {Icon} from '@/components/icon-custom'
import {loginApi, loginCategoryApi, queryDekey} from '@/api/login'
...
<template>
    ...
    />
    <div v-show="contentShow" v-loading="duringLogin" class="login-background">
        <div ref="loginContainer" class="login-container">
            <div v-if="showLoginImage" v-loading="!axiosFinished" class="login-image-content">
                <el-image
                    v-if="axiosFinished"
            ...
            <div v-loading="loading" class="login-form-content">
