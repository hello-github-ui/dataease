...
import {buildVersionApi, revertApi, updateInfoApi, validateApi} from '@/api/about'
...
<template>
    <el-dialog
        ...
        width="840px"
    >
        <img :src="aboutBg" height="180" width="792"/>
        ...
        <div class="content">
            ...
            <div class="item">
                ...
                <div :class="{ 'expired-mark': license.status === 'expired' }" class="value">
                    {{ license.expired }}
                </div>
            </div>
            <div class="item">
            ...
            <div v-if="isAdmin" class="lic_rooter" style="margin-top: 24px">
                <el-upload
