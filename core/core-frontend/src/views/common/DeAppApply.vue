            ...
            >
              ...
              <span class="custom-tree-node">
                ...
                <el-row class="datasource-link">
                    <el-row class="head">
                        <el-col :span="11">{{ t('visualization.app_datasource') }}
                        </el-col
                        >
                    ...
                    >
                        <el-col :span="11">
                            <el-select v-model="appDatasource.name" disabled style="width: 100%">
                                <el-option
...
import {ElButton, ElDrawer, ElForm, ElFormItem, ElInput, ElMessage, ElTreeSelect} from 'element-plus-secondary'
...
import {deepCopy, filterFreeFolder} from '@/utils/utils'
