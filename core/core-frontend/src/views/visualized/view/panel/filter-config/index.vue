    ...
    <div class="config-filter">
        <div class="name">
            ...
            <el-icon>
                <Icon name="icon_view-list_outlined">
                    <icon_viewList_outlined class="svg-icon"/>
                </Icon>
            </el-icon>
        </div>
        <el-tabs v-model="activeNameData" @tab-click="handleTabClick">
            ...
            <el-tab-pane label="图表" name="chart">
                <div class="setting-item">
                    <div class="value">
                        <el-select v-model="attrs.title" filterable>
                            <el-option
        ...
        <el-tabs v-model="activeName">
            <el-tab-pane label="设置" name="setting">
                ...
                <div class="setting-item">
                    ...
                    <div class="value">
                        <el-select v-model="attrs.parameters" filterable>
                            <el-option
                ...
                <div class="setting-item">
                    ...
                    <div class="value">
                        <el-select v-model="attrs.viewIds" filterable multiple>
                            <el-option
                ...
                <div class="setting-item">
                    <div class="title">
                        <el-checkbox v-model="attrs.multiple" @change="multipleChange"
                        >是否允许多选
                        </el-checkbox
                        >
                    </div>
            ...
            <el-tab-pane label="样式" name="style">
                <div class="setting-item">
                    ...
                    <div class="value">
                        <div class="color">
                            背景:
                            <el-color-picker v-model="customStyle.background" show-alpha/>
                        </div>
                        <div class="color">
                            边框:
                            <el-color-picker v-model="customStyle.border" show-alpha/>
                        </div>
                        <div class="color">颜色:
                            <el-color-picker v-model="customStyle.text" show-alpha/>
                        </div>
                    </div>
                </div>
                <div class="setting-item">
