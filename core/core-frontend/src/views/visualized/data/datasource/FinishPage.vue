    ...
    <div class="finish-page-content">
        <div class="finish-page">
            <el-icon class="succeed-icon">
                <Icon name="icon_succeed_colorful">
                    <icon_succeed_colorful class="svg-icon"/>
                </Icon>
            </el-icon>

            <div class="succeed-text">{{ t('data_source.successfully_created') }}</div>
            <div class="btn-list">
                <el-button secondary @click="continueCreating">
                    {{ t('data_source.continue_to_create') }}
                </el-button>
                <el-button type="primary" @click="backToDatasourceList">
            ...
            <div v-permission="['dataset']" class="maybe-want">
                ...
                <div class="ds-info">
                    ...
                    <el-button :disabled="disabled" class="create" secondary @click="createDataset">
