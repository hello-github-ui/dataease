...
import {onBeforeMount, PropType, toRefs, watch} from 'vue'
import {useI18n} from '@/hooks/web/useI18n'
import ApiVariable from './ApiVariable.vue'
import CodeEdit from './CodeEdit.vue'
import Convert from './convert.js'
import {BODY_TYPE, KeyValue} from './ApiTestModel.js'
...
<template>
    <div class="radio-group_api">
        ...
        <div v-if="apiBody.type == 'Form_Data' || apiBody.type == 'WWW_FORM'" style="padding-top: 16px">
            <api-variable
