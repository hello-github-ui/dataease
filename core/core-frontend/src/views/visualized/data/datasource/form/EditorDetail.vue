...
import {ComponentPublicInstance, computed, nextTick, reactive, ref, toRefs, watch} from 'vue'
...
import type {ApiConfiguration, Configuration, SyncSetting} from './option'
    ...
    <div class="editor-detail">
        <div class="detail-inner create-dialog">
            ...
            >
                ...
                <el-form-item v-show="activeStep !== 2" :label="t('common.description')">
                    <el-input
                ...
                <template v-if="form.type.startsWith('API')">
                    <div v-show="activeStep !== 2" class="title-form_primary flex-space table-info-mr">
                        ...
                        <el-button style="margin-left: auto" type="primary" @click="() => addApiItem(null)">
                            <template #icon>
                    ...
                    >
                      ...
                      >
                        ...
                        <template #default>
                          ...
                          <div class="foot">
                            <el-button secondary style="min-width: 48px" @click="cancelItem(idx)">{{
                                    t('common.cancel')
                                }}</el-button>
                            <el-button
                ...
                <template v-if="notapiexcelconfig">
                    ...
                    <el-form-item v-if="form.type !== 'presto'" :label="t('datasource.user_name')">
                        <el-input
                            v-model="form.configuration.username"
                    ...
                    <el-form-item v-if="form.type !== 'presto'" :label="t('datasource.password')">
                        <CustomPassword
                            v-model="form.configuration.password"
                    ...
                    >
                        <template v-slot:label>
                            ...
                            <el-button size="small" text @click="getDsSchema()">
                                <template #icon>
                                    <Icon name="icon_add_outlined">
                                        <icon_add_outlined class="svg-icon"/>
                                    </Icon>
          ...
          "
                ...
                >
                    ...
                    <el-form-item v-if="form.syncSetting.syncRate === 'CRON'" prop="syncSetting.cron">
                        <el-popover v-model="cronEdit" :width="834" trigger="click">
                            <template #default>
                ...
                >
                    ...
                    <el-form-item :label="t('deDataset.parameter_type')" prop="deType">
                        <el-radio-group v-model="paramsObj.deType">
                            <el-radio :label="t('data_source.text')" :value="0"></el-radio>
                            <el-radio :label="t('data_source.numerical_value')" :value="2"></el-radio>
                            <el-radio :label="t('data_source.numeric_value_decimal')" :value="3"></el-radio>
                        </el-radio-group>
                    </el-form-item>
                </el-form>
                <template #footer>
            ...
            >
                ...
                >
                    <el-form-item :label="t('data_source.interface_name')" prop="name">
                        <el-input v-model="apiObj.name" :placeholder="t('data_source.the_interface_name')"/>
                    </el-form-item>
                </el-form>
                <template #footer>
            ...
            <api-http-request-draw ref="editApiItem" @return-item="returnItem"></api-http-request-draw>
        </div>
    </div>
</template>
