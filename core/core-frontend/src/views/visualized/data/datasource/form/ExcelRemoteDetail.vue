...
import {h, nextTick, onBeforeUnmount, onMounted, reactive, ref, shallowRef, toRefs, watch} from 'vue'
import {useI18n} from '@/hooks/web/useI18n'
import {type Action, ElForm, ElIcon, ElMessage, ElMessageBox, FormInstance, FormRules} from 'element-plus-secondary'
...
<template>
    <div class="editor-detail">
        <div class="detail-inner create-dialog">
            ...
            <div v-show="activeStep !== 2" class="title-form_primary base-info">
            ...
            >
                ...
                <el-form-item v-show="activeStep !== 2" :label="t('datasource.username')">
                    <el-input
                ...
                <el-form-item v-show="activeStep !== 2" :label="t('datasource.password')">
                    <CustomPassword
            ...
            <template v-if="activeTab">
                <div v-show="activeStep !== 2" class="title-form_primary">
                ...
                <div v-if="form.editType === 0" v-show="activeStep !== 2" class="table-select_mode">
                ...
                >
                    ...
                    >
                        ...
                        <el-table-column :label="t('datasource.field_type')" prop="deExtractType">
                            <template #default="scope">
                                ...
                                >
                                    <template #prefix>
                                        <el-icon>
                                            <Icon
                                                :className="`field-icon-${fieldTypeLowercase[scope.row.deExtractType]}`"
                                            >
                                                <component
