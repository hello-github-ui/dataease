...
import {computed, inject, onBeforeMount, PropType, toRefs} from 'vue'
...
<template>
    <div class="api-key-value">
        <draggable :list="items" class="draggable-content_api" handle=".handle" tag="div">
            <template #item="{ element, index }">
                <div style="margin-bottom: 16px">
                    <el-row :gutter="8">
                        ...
                        <el-col v-if="!unShowSelect" :span="activeName === 'params' ? 8 : 6">
                            <el-input
                                v-if="!suggestions"
                        ...
                        <el-col v-if="activeName === 'table'" :span="3">
                        ...
                        <el-col v-if="unShowSelect" :span="8">
                            <el-input
        ...
        <el-button style="margin-top: 14px" text @click="change">
            <template #icon>
