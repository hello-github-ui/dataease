...
import {computed, h, nextTick, onBeforeUnmount, onMounted, reactive, ref, shallowRef, toRefs} from 'vue'
import {fieldType as fieldTypeLowercase} from '@/utils/attr'
import {save, update, uploadFile} from '@/api/datasource'
        ...
        <div class="detail-inner">
                    ...
                    :rules="[
            {
              required: true
                ...
                >
                    ...
                    <div v-if="status" class="ed-form-item__error">
          ...
          "
            ...
            <template v-if="activeTab">
                ...
                <div v-if="param.editType === 0" class="table-select_mode">
