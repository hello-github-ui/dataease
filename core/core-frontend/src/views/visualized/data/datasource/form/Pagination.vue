...
<template>
    <div class="api-pagination">
        ...
        <template v-if="page.pageType !== 'empty'">
            ...
            <el-table :data="page.requestData" header-cell-class-name="header-cell" style="width: 100%">
                <el-table-column :label="t('api_pagination.parameter_name')" prop="parameterName"/>
                <el-table-column
            ...
            <el-table :data="page.responseData" header-cell-class-name="header-cell" style="width: 100%">
                <el-table-column
                    :label="t('api_pagination.parameter_name')"
                    prop="parameterName"
                    width="160"
                />
                <el-table-column :label="t('api_pagination.parsing_path')" prop="resolutionPath">
                    <template #default="scope">
                        <el-input
