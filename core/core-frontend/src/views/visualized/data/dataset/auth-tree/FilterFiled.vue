...
import {dateOptions, fieldEnums, sysParamsIlns, textOptions, textOptionsForSysParams, valueOptions} from '../options.js'
        ...
        >
            ...
            "
                    ...
                    <template v-else-if="!['null', 'empty', 'not_null', 'not_empty'].includes(item.term)">
                        <el-input v-model="item.value" class="w70 mar5" size="small"/>
                        <div class="bottom-line"></div>
                    </template>
                </template>
