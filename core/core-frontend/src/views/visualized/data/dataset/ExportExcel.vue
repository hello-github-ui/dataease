...
import {exportDelete, exportDeleteAll, exportDeletePost, exportRetry, exportTasks} from '@/api/dataset'
...
<template>
    ...
    >
        ...
        <div :class="!tableData.length && 'hidden-bottom'" class="table-container">
            <el-table
                ref="multipleTable"
                :data="tableData"
                height="100%"
            ...
            >
                ...
                <el-table-column :label="$t('driver.file_name')" prop="fileName" width="332">
                ...
                <el-table-column :label="$t('data_export.export_obj')" prop="exportFromName" width="200"/>
                <el-table-column :label="$t('data_export.export_time')" prop="exportTime" width="180">
                    <template #default="scope">
                        <span>{{ timestampFormatDate(scope.row.exportTime) }}</span>
                    </template>
                </el-table-column>
                <el-table-column :label="$t('data_export.export_from')" prop="exportFromType" width="120">
                    <template #default="scope">
                ...
                <el-table-column
                    ...
                    width="200"
                />
                <el-table-column :label="$t('commons.operating')" fixed="right" prop="operate" width="90">
                    <template #default="scope">
                        <el-tooltip :content="t('data_set.download')" effect="dark" placement="top">
                            <el-button
                        ...
                        <el-tooltip :content="t('data_set.re_export')" effect="dark" placement="top">
                        ...
                        <el-tooltip :content="t('data_set.delete')" effect="dark" placement="top">
    ...
    <el-dialog v-model="msgDialogVisible" :title="t('data_set.reason_for_failure')" width="30%">
        <span>{{ msg }}</span>
