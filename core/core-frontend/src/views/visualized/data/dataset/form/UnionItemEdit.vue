    ...
    <div class="union-container">
        <div class="union-header">
            ...
            <div class="union-header-operator">
                ...
                <el-button class="union-add" type="primary" @click="addUnion">
                    <template #icon>
                        <el-icon>
        ...
        <div class="union-body">
            <div class="union-body-header">
                <span :title="tableName" class="column">{{ tableName }}</span>
                <span :title="node.tableName" class="column">{{ node.tableName }}</span>
            </div>
