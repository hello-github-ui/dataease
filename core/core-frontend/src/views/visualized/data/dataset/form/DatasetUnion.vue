...
import {computed, inject, nextTick, reactive, ref, type Ref, unref, watch} from 'vue'
import type {SqlNode} from './AddSql.vue'
import AddSql from './AddSql.vue'
import {useI18n} from '@/hooks/web/useI18n'
import zeroNodeImg from '@/assets/img/drag.png'
import {type Action, ElMessageBox} from 'element-plus-secondary'
import type {Field, Node} from './util'
...
<template>
    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <el-icon>
                        <Icon>
                            <component :is="iconName[ele.to.unionType]" class="svg-icon"></component>
                        </Icon>
                    </el-icon>
                </div>
            </foreignObject>
            ...
            :class="[
        {
          'mask-dataset-none': !state.nodeList.length
            ...
            class="mask-dataset"
        ></div>
        <div v-if="!state.nodeList.length" class="zero">
        ...
        >
                ...
                :rules="[
          {
            ...
            message: t('commons.cannot_be_null')
                ...
                prop="name"
            >
                <el-input v-model="renameParam.name" :placeholder="t('common.inputText')"></el-input>
            </el-form-item>
        </el-form>
        <template #footer>
    ...
    <el-drawer
        ...
        size="600px"
    >
        <template v-if="currentNode" #header>
            <div style="width: 100%">
                <div class="info">
          ...
          >
                ...
                <div class="info" style="margin-top: 4px">
          <span :title="currentNode.noteName" class="name ellipsis" style="max-width: 500px"
    ...
    <el-drawer
        ...
        size="calc(100% - 100px)"
    >
        <add-sql :sqlNode="sqlNode" @close="closeSqlNode" @save="saveSqlNode"></add-sql>
    </el-drawer>
</template>
