...
import {createDatasetTree, getDatasetTree, moveDatasetTree, renameDatasetTree} from '@/api/dataset'
    ...
    >
        ...
        >
            <el-form-item v-if="showName" :label="labelName" prop="name">
                <el-input v-model="datasetForm.name" :placeholder="placeholder"/>
            </el-form-item>
            ...
            <div v-if="cmd === 'move'">
                <el-input v-model="filterText" clearable style="margin-bottom: 12px">
                    <template #prefix>
                        <el-icon>
