...
<template>
    <div class="calcu-field" @keydown.stop @keyup.stop>
            ...
            <div style="flex: 1">
                ...
                },
                {
                  ...
                  message: t('commons.char_can_not_more_50')
                    ...
                    <div>
                        <el-form ref="form" :model="fieldForm" inline label-position="top">
                            <el-form-item :label="t('dataset.data_type')" class="mr12">
                            ...
                            <el-form-item :label="t('dataset.field_type')" class="mr0">
              ...
              "
                ...
                >
                  ...
                  <div v-if="!item.groupType" class="icon-right">
                    <el-icon class="hover-icon" @click.stop="updateParmasToQuota">
                      <Icon name="icon_edit_outlined"><icon_edit_outlined class="svg-icon"/></Icon>
                    </el-icon>
                    <el-icon class="hover-icon" @click.stop="delParmasToQuota">
