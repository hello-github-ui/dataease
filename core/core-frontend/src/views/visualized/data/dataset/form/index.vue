...
import type {Action, FormInstance} from 'element-plus-secondary'
...
import {type DataSource, getFieldName, guid, timeTypes} from './util'
...
<template>
    <div v-loading="loading" class="de-dataset-form">
        <div class="top">
      <span class="name">
        ...
        <template v-if="showInput">
          ...
          />
          <div v-if="errorTips" class="ed-form-item__error">{{ errorTips }}</div>
        </template>
        <template v-else>
          <span class="dataset-name ellipsis" style="margin-left: 12px" @click="handleClick">{{
                  datasetName
              }}</span>
        </template>
      </span>
        ...
        <div class="container dataset-db" @mouseup="mouseupDrag">
            ...
            >
                        ...
                        <template #default="{ data: { name, leaf, type, extraFlag } }">
                            <div class="flex-align-center icon">
                                <el-icon>
                                    ...
                                    >
                                        <component :is="getDsIconName({ leaf, type })" class="svg-icon"></component
                                        >
                                    </icon>
                                </el-icon>
              ...
              {{ datasourceTableData.length }}
                ...
                <div v-else class="table-checkbox-list">
                    ...
                    >
                        <el-icon class="icon-color">
                            <Icon name="icon_sql_outlined_1">
                                <icon_sql_outlined_1 class="svg-icon"/>
                            </Icon>
                        </el-icon>
            ...
            <div :style="{ width: `calc(100vw - ${showLeft ? LeftWidth : 0}px)` }" class="drag-right">
                <div v-if="crossDatasources" class="different-datasource">
                    <el-icon>
                        <Icon name="icon_warning_colorful">
                            <icon_warning_colorful class="svg-icon"/>
                        </Icon>
                    </el-icon>
                ...
                >
                    <div class="sql-title">
                        ...
                        <div class="field-data">
                            <el-button :disabled="!allfields.length" secondary @click="addCalcField('q')">
                                <template #icon>
                                    <el-icon>
                            ...
                            <el-button :disabled="!allfields.length" secondary @click="addGroupField">
                                <template #icon>
                                    <el-icon>
                                        <Icon>
                                            <icon_organization_outlined class="svg-icon"/>
                                        </Icon>
                                    </el-icon>
                                </template>
                    ...
                    <el-tabs v-model="tabActive" class="padding-24" @tab-change="tabChange">
                        ...
                        <div class="preview-data">
                            ...
                            >
                              ...
                              fieldType[[2, 3].includes(column.deType) ? 2 : 0]
                                            ...
                                            <span :title="column.title" class="ellipsis" style="width: 120px">
                        {{ column.title }}
                      </span>
                                        </div>
                                    </template>
                    ...
                    <div v-show="tabActive !== 'preview' && !!allfields.length" class="batch-area">
                        <div class="manage-container">
                            <el-collapse v-model="state.fieldCollapse" class="style-collapse">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <el-table-column :label="t('dataset.field_name')" prop="name" width="264">
                                        ...
                                        >
                                            <template #default="scope">
                                                <div class="column-style">
                          <span v-if="scope.row.extField === 2" style="color: #8d9199">{{
                                  t('dataset.calc_field')
                              }}</span>
                                                    <span v-else-if="scope.row.extField === 3" style="color: #8d9199">{{
                                        ...
                                        >
                                            <template #default="scope">
                                                <div class="column-style">
                                                    ...
                                                    <span v-else style="color: #8d9199">&nbsp;</span>
                                                </div>
                                            </template>
                                        </el-table-column>
                                        <el-table-column
                                        ...
                                        <el-table-column :label="t('dataset.field_type')" prop="deType" width="200">
                                            <template #default="scope">
                                                <el-cascader
                          ...
                          "
                                    ...
                                    fieldType[[2, 3].includes(data.value) ? 2 : 0]
                                                ...
                                                <div v-else style="padding-left: 30px">{{ $t('data_set.text') }}</div>
                          ...
                          <span v-if="scope.row.extField === 2" style="color: #8d9199">{{
                                  t('dataset.calc_field')
                                                    ...
                                                    <span v-else-if="scope.row.extField === 0"
                            ...
                            {{ fieldTypes(scope.row.deExtractType) }}
                                        ...
                                        <el-table-column :label="t('chart.dimension')" fixed="right">
                                            <template #default="scope">
                                                <el-tooltip
                                        ...
                                        <el-table-column :label="t('dataset.operator')" fixed="right" width="168">
                                            <template #default="scope">
                                                <el-tooltip :content="t('dataset.copy')" effect="dark" placement="top">
                                                    <template #default>
                                                ...
                                                <el-tooltip :content="t('dataset.delete')" effect="dark"
                                                            placement="top">
                                                    <template #default>
                                                ...
                                                <el-tooltip :content="t('dataset.edit')" effect="dark" placement="top">
                                                    <template #default>
                                                        <el-button
                                        ...
                                        >
                                            <template #default="scope">
                                                <div class="column-style">
                                                    ...
                                                    <span v-else style="color: #8d9199">{{
                                                            t('dataset.calc_field')
                                                        }}</span>
                                                </div>
                                            </template>
                          ...
                          <span v-if="scope.row.extField === 2" style="color: #8d9199">{{
                            ...
                            {{ fieldTypes(scope.row.deExtractType) }}
                                        ...
                                        <el-table-column :label="t('chart.quota')" fixed="right">
                                            <template #default="scope">
                                                <el-tooltip
                        ...
                        <div v-if="!!deTypeSelection.length" class="batch-operate flex-align-center">
                            <div class="flex-align-center">
                                {{ t('data_set.selected') }}
                                <span class="num">{{ deTypeSelection.length }}</span>
                                {{ t('data_set.bar') }}
                                <el-button style="margin-left: 16px" text @click="clearSelection">{{
                                        t('commons.clear')
                                    }}
                                </el-button>
                            </div>
                  ...
                  <el-icon>
                    ...
                    ></Icon>
                                ...
                                <el-tooltip class="item" effect="dark" placement="top">
                                    ...
                                    <el-icon v-show="!showCascaderBatch" size="16px" style="margin-left: 6px">
    ...
    <el-dialog
        ...
        width="1000px"
    >
        <el-form ref="ruleFormRef" :model="currentField" :rules="rules" label-width="120px">
            <el-form-item :label="t('data_set.custom_time_format')" prop="name">
    ...
    >
        ...
        >
            <el-form-item :label="t('dataset.field_name')" prop="name">
    ...
    >
        ...
        >
            <el-row :gutter="24">
                ...
                <el-col :span="12">
                    <el-form-item :label="t('dataset.grouping_field')" prop="originName">
                        <el-select
            ...
            <el-button style="margin-top: -20px" text @click="addGroupFields">
                <template #icon>
                    <icon>
                        <icon_add_outlined class="svg-icon"/>
                    </icon>
