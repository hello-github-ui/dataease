<template>
    <el-container class="online-map-container">
        <el-aside class="online-map-aside" width="200px">
            <div class="geo-title">
                    ...
                    <div class="online-form-item">
                        ...
                        <div class="map-item">
                            <el-select v-model="mapEditor.mapType" @change="initLoad">
                                <el-option :label="t('chart.map_type_gaode')" value="gaode"/>
                                <el-option :label="t('chart.map_type_tianditu')" value="tianditu"/>
                                <!--                <el-option value="baidu" :label="t('chart.map_type_baidu')" />-->
                                <el-option :label="t('chart.map_type_tencent')" value="qq"/>
                            </el-select>
                        </div>
                        <div class="map-item">
                            <div class="map-item-label">
            ...
            <el-row>
                <el-button :disabled="!mapEditor.key" type="primary" @click="saveHandler">
                    {{ t('commons.save') }}
                </el-button>
            </el-row>
        </el-aside>
