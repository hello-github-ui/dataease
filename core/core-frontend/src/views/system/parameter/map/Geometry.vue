<template>
    <el-container class="geometry-container">
        <el-aside class="geonetry-aside">
            ...
            <div class="map-tree-container">
              ...
              <span :class="{ 'is-disabled': node.disabled || data.root }" class="custom-tree-node">
                <span
                    :title="data.name"
                    class="geo-name-span"
                ...
                <span v-if="data.custom" class="geo-operate-container">
                  <el-tooltip
                      ...
                      placement="top"
                  >
                    <el-icon class="hover-icon" @click.stop="delHandler(data)">
              ...
              <span class="custom-area-root">
                <span :title="data.name" class="label">
                  {{ data.name }}
                </span>
                <span v-if="data.id === '000'" class="opt-icon" @click.stop="editCustomArea()">
                  <el-icon>
                    <Icon name="icon_add_outlined"><icon_add_outlined/></Icon>
                  </el-icon>
                </span>
                <el-dropdown v-else placement="bottom-end" popper-class="area-opt-popper">
                  <span class="opt-icon">
                    <el-icon>
        ...
        <el-main class="geometry-main">
            <template v-if="showGeoJson">
                <div v-if="!selectedData" class="geo-content-container">
                    <EmptyBackground :description="t('system.on_the_left')" img-type="noneWhite"/>
                </div>
            ...
            <template v-else>
                ...
                <div v-else class="sub-area-view">
              ...
              <span class="add-btn" @click="editCustomSubArea()">
                ...
                <span>{{ t('system.add_area') }}</span>
                        ...
                        <el-table :data="subAreaList" :height="300" stripe style="width: 100%">
                            <el-table-column :label="t('system.area_name')" prop="name">
                  ...
                  ></span>
                            ...
                            <el-table-column :label="t('system.area_scope')" prop="scopeName"/>
                            <el-table-column :label="t('system.operation')" fixed="right" min-width="120">
    ...
    >
        <el-form
            ...
            label-width="auto"
        >
            <el-form-item label-position="top" prop="name" required>
                <el-input v-model="editedCustomArea.name" :maxlength="50" :minlenegth="1"/>
            </el-form-item>
        </el-form>
        <template #footer>
    ...
    >
        ...
        >
            <el-form-item :label="t('system.area_name')" label-position="top" prop="name">
                <el-input v-model="customSubArea.name" :maxlength="50" :minlenegth="1"/>
            </el-form-item>
            <el-form-item :label="t('system.sub_area_tip')" label-position="top" prop="scopeArr">
                <el-select v-model="customSubArea.scopeArr" filterable multiple style="width: 100%">
                    <el-option
