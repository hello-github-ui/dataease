...
import type {FormInstance, FormRules, UploadProps, UploadRequestOptions} from 'element-plus-secondary'
    ...
    >
        ...
        >
          ...
          <span class="area-code-label">
            ...
            <el-tooltip :content="codeTips" effect="dark" placement="top">
