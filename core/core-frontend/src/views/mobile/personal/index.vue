    ...
    <div class="de-mobile-user">
        <template v-if="showNavBar">
            ...
            <div class="mobile-user-top">
                <van-image :src="userImg" height="48" round width="48"/>
                <div class="user-name">
                    {{ userStore.name }}
                </div>
            </div>
        ...
        <template v-else>
            ...
            <div class="cell-org_scroll">
                <div class="grey">
                    <div class="flex-align-center" @click="clearOrg">
                        <span :class="!!directName.length && 'active'" class="ellipsis">组织</span>
                    ...
                    >
                        <span :class="ele !== activeDirectName && 'active'" class="ellipsis">{{ ele }}</span>
