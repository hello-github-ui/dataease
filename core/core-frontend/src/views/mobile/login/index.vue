...
<template>
    ...
    />
    <div v-loading="duringLogin" class="de-mobile-login">
        <img :src="mobileLoginBg ? mobileLoginBg : mobileWholeBg" alt="" class="mobile-login_bg"/>
        <div class="mobile-login-content">
            <img :src="mobileLogin ? mobileLogin : mobileDeTop" alt="" height="31" width="120"/>
