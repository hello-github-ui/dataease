<template xmlns:el-col="http://www.w3.org/1999/html">
    <el-row class="watermark-table__content">
        <el-row class="watermark-main-outer">
            <el-col :span="12" class="main-col-left">
                <el-form ref="watermarkForm" :model="state.watermarkForm" label-width="120px" size="middle">
                    ...
                    <el-form-item :label="t('watermark.content')" style="text-align: left">
                        <el-select v-model="state.watermarkForm.type" :disabled="!state.watermarkForm.enable">
                ...
                <el-row style="margin-left: 53px; text-align: left">
                    ...
                    <el-button size="middle" type="primary" @click="save"
                    >{{ t('watermark.save') }}
                    </el-button>
                </el-row>
            </el-col>
            <el-col :span="12" style="height: 100%">
                ...
                >
                    <div class="demo-preview">
                        <img src="@/assets/img/watermark-demo-light.png" style="height: 100%"/>
                    </div>
                    <div class="demo-preview" style="margin-top: 15px">
                        <img src="@/assets/img/watermark-demo-dark.png" style="height: 100%"/>
                    </div>
                </div>
            </el-col>
        </el-row>
