<template>
    ...
    <div class="sys-setting-p">
        <div v-show="state.templateCategories.length" class="container-sys-param">
                ...
                >
                  ...
                  {{ t('template_manage.no_template') }}
                            ...
                            >
                                <Icon name="dv-nothing">
                                    <dvNothing class="svg-icon" style="width: 125px; height: 125px"/>
                                </Icon>
                                <span style="margin-top: 8px; font-size: 14px">
                  {{ t('template_manage.not_found') }}
                            ...
                            <div v-show="batchState" class="batch-opt-area">
                                <el-button plain style="margin-left: 24px" @click="batchUpdate"
                  ...
                  {{ t('template_manage.selected_count', [batchState]) }}
                                ...
                                <el-button style="margin-left: 16px" text @click="batchFullSelect">
                                    {{
                                        t('template_manage.select_all_count', [currentTemplateShowListComputed.length])
                                    }}
                                </el-button>
                                <el-button text @click="batchClear">{{ t('commons.clear') }}</el-button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div v-show="!state.templateCategories.length" class="container-sys-param">
            <el-row class="custom-position" style="height: 100%">
                <Icon name="dv-empty">
                    <dvEmpty class="svg-icon" style="width: 125px; height: 125px"/>
                </Icon>
                <span style="margin-top: 8px; font-size: 14px">
...
import {batchDelete, deleteCategory, find, findCategories, save, templateDelete} from '@/api/template'
