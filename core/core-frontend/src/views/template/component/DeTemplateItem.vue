<template>
    <div
        ...
        class="de-card-model"
    >
        <el-checkbox v-model="model.checked" class="custom-item-checkbox"/>
        <div :style="classImg" class="card-img-model">
            <img :src="imgUrlTrans(model.snapshot)" alt=""/>
        </div>
        <div class="card-info">
            <div style="display: flex; align-items: center; width: calc(100% - 24px)">
                <el-tooltip :content="model.name" class="item" effect="dark" placement="top">
