<template>
    <div class="template-import">
        ...
        >
            <el-form-item :label="t('template_manage.template_name')" prop="name">
                <div class="flex-template">
                    <el-input
                        ...
                        clearable
                    />
                    <el-button icon="Upload" secondary style="margin-left: 10px" @click="goFile">
            ...
            <el-row v-show="!!state.templateInfo.snapshot" :style="classBackground" class="preview"/>
            <el-form-item
          ...
          "
                ...
                >
                    ...
                    <div class="custom-option-line">
                        <div class="flex-align-center" @click="doAddCategory">
                            <el-icon>
                                <Plus></Plus>
                            </el-icon>
...
import {categoryTemplateNameCheck, findOne, nameCheck, save} from '@/api/template'
