...
<template>
    <div v-loading="requestStore.loadingMap[permissionStore.currentPath]" class="workbranch">
        <div class="info-quick-creation">
            <div class="user-info">
                <el-icon class="main-color user-icon-container">
                    <Icon name="user-img">
                        <userImg class="svg-icon"/>
                    </Icon>
                </el-icon>
                <div class="info">
            ...
            <div class="quick-creation">
              ...
              'quick-create-disabled': !ele['menuAuth'] || !ele['anyManage']
                    ...
                    >
                        ...
                        <el-icon :style="{ backgroundColor: ele.color }" class="main-color">
                            <Icon>
                                <component :is="ele.icon" class="svg-icon"></component>
                            </Icon>
                        </el-icon>
                        <span class="name">
              {{ t(`auth.${ele.name}`) }}
                    ...
                    >
                        ...
                        <el-icon class="main-color-quick template-create">
                            <Icon name="icon_template_colorful">
                                <icon_template_colorful class="svg-icon"/>
                            </Icon>
                        </el-icon>
        ...
        <div class="template-market-dashboard">
            <div :style="{ paddingBottom: expandFold !== 'fold' ? '24px' : 0 }" class="template-market">
                <div class="label">
                    ...
                    <div class="expand-all">
                        ...
                        <button class="expand flex-center" @click="handleExpandFold">
                ...
                <template v-if="expandFold === 'fold'">
                    ...
                    <div v-show="state.networkStatus && state.hasResult" class="template-list">
                    ...
                    <el-row v-show="state.networkStatus && !state.hasResult" class="template-empty">
                        <div style="text-align: center">
                            <Icon class="no-result" name="no_result"
                            >
