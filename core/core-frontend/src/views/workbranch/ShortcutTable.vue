    ...
    >
        ...
        <template v-if="busiAuthList.length">
            ...
            <div v-if="activeName === 'recent' || activeName === 'store'" class="panel-table">
                ...
                >
                    <el-table-column key="name" :label="t('common.name')" prop="name" width="280">
                        <template v-slot:default="scope">
                            <div :class="{ 'jump-active': jumpActiveCheck(scope.row) }" class="name-content">
                    ...
                    checkDisabled(scope.row) ? '-disabled' : ''
                                ...
                                >
                                    <Icon
                                    >
                                        <component :is="iconMap[scope.row.type]" class="svg-icon"></component
                                        >
                                    </Icon>
                                </el-icon>
              ...
              <span :class="{ 'jump-active': jumpActiveCheck(scope.row) }">
                ...
                <span v-else>{{ scope.row[item.field] }}</span>
                    ...
                    <el-table-column key="_operation" :label="$t('common.operate')" fixed="right" width="100">
                        <template #default="scope">
                            <div
                      ...
                      "
                                    ...
                                    >
                                        ...
                                        >
                                            <Icon name="icon_cancel_store">
                                                <visualStar class="svg-icon"/>
                                            </Icon>
                                        </el-icon>
                                    </el-tooltip>
                                </template>
